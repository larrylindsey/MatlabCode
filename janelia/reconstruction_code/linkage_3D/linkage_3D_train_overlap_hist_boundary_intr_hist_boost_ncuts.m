function linkage_3D_train_overlap_hist_boundary_intr_hist_boost_ncuts(config)
...
fprintf('START: linkage_3D_train_overlap_hist_boundary_intr_hist_boost_ncuts\n');
...
if(max(strcmp(model_config.type, {'boost_ncuts'}))==0)
...
fprintf('STOP: linkage_3D_train_overlap_hist_boundary_intr_hist_boost_ncuts\n');
return;
end
