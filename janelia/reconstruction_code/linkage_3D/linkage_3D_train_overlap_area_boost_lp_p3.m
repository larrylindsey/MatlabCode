function linkage_3D_train_overlap_area_boost_lp_p3(config)
...
fprintf('START: linkage_3D_train_overlap_area_boost_lp_p3\n');
...
fprintf('STOP: linkage_3D_train_overlap_area_lp_p3\n');
return;
end
