function linkage_3D_train_overlap_area_boundary_hist_boost_lp_p3(config)
...
fprintf('START: linkage_3D_train_overlap_area_boundary_hist_boost_lp_p3\n');
...
version_names{1} = 'overlap_area_boundary_hist';
...
for z = 1:length(manual_annotation.al)
  ...
  features{z} = boundary_feature; %#ok<AGROW>
  ...
  labels{z} = 2*double(is_same_label)-1; %#ok<AGROW>
end
fprintf('done\n');
...
fprintf('STOP: linkage_3D_train_overlap_area_boundary_hist_boost_lp_p3\n');
return;
end
