  ...
  for tile_1 = 1:length(image_prefixes_1)
    for tile_2 = 1:length(image_prefixes_2)
      ...
      seg_map_auto_2_gt_1 = assign_auto_seg_label_to_groundtruth(...
        segment_2D_label_map_1{tile_1}.label_map, body_map_gt_1, map_param);
      seg_map_auto_2_gt_2 = assign_auto_seg_label_to_groundtruth(...
        segment_2D_label_map_2{tile_2}.label_map, body_map_gt_2, map_param);
      ...
      shadow.features = [boundary_hist_1(:, 3:end); boundary_hist_2(:, 3:end)];
      shadow.labels = [2*(apply_mapping(boundary_hist_1(:,1), seg_map_auto_2_gt_1)...
        ==apply_mapping(boundary_hist_1(:,2), seg_map_auto_2_gt_1))-1; ...
        2*(apply_mapping(boundary_hist_2(:,1), seg_map_auto_2_gt_2)...
        ==apply_mapping(boundary_hist_2(:,2), seg_map_auto_2_gt_2))-1];
      
      fprintf('saving linkage graph:\n%s\n', file_name_features);
      save2(file_name_features, 'features', 'link_labels', ...
        'features_insection', 'labels_insection', 'shadow');
    end
  end
