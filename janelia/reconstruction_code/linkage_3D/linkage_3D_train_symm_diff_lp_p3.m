function linkage_3D_train_symm_diff_lp_p3(config) %#ok<INUSD>
% linkage_3D_train_isymm_diff_lp_p3(config)
...
fprintf('START: linkage_3D_train_isymm_diff_lp_p3\n');

fprintf('This method does not have training yet.\n');

fprintf('STOP: linkage_3D_train_isymm_diff_lp_p3\n');
return;
end
