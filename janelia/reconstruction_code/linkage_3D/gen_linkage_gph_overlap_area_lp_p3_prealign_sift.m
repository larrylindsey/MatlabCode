function gen_linkage_gph_overlap_area_lp_p3_prealign_sift(config)
...
fprintf('START: gen_linkage_gph_overlap_area_lp_p3_prealign_sift\n');
...
fprintf('done\n');
fprintf('STOP: gen_linkage_gph_overlap_area_lp_p3_prealign_sift\n');
