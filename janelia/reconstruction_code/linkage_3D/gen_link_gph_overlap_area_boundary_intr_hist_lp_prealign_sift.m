function gen_link_gph_overlap_area_boundary_intr_hist_lp_prealign_sift(config)
...
fprintf('START: gen_link_gph_overlap_area_boundary_intr_hist_lp_prealign_sift\n');
...
fprintf('done\n');
fprintf('STOP: gen_link_gph_overlap_area_boundary_intr_hist_lp_prealign_sift\n');
