function linkage_train_collect_feat_overlap_hist_multi_tile(config)
...
if(config.linkage.is_verbose)
  fprintf('START: linkage_train_collect_feat_overlap_hist_multi_tile\n');
end
...
if(linkage_config.is_verbose)
  fprintf('STOP: linkage_train_collect_feat_overlap_hist_multi_tile\n');
end
return
end
