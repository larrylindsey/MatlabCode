function superpixel_2_seg_sub_agglo_AMB_ABIFL_AMdB(...
  superpixel_seg, boundary_map, image, seg_config, version_name, save_prefix, ...
  superpixel_suffix, exclusion_mask, proofread_seg)
...
if(seg_config.is_verbose)
  fprintf('START: superpixel_2_seg_sub_agglo_AMB_ABIFL_AMdB\n');
end
...
if(seg_config.is_verbose)
  fprintf('STOP: superpixel_2_seg_sub_agglo_AMB_ABIFL_AMdB\n');
end
return;
end
