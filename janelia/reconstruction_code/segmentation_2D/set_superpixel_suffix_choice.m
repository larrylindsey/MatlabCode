function set_superpixel_suffix_choice(config)
% set_superpixel_suffix_choice(config)(config)
% Set superpixel choice as specified in config.superpixel_choose.set_choice
...
fprintf('START:set_superpixel_suffix_choice\n');
...
fprintf('STOP:set_superpixel_suffix_choice\n');
return
end
