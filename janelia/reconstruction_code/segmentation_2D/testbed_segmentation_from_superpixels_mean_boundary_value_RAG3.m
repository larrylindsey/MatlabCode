function [result, segment_map_ws, boundary_map] = ...
      testbed_segmentation_from_superpixels_mean_boundary_value_RAG3(case_id)
  ...
  switch(case_id)
    ...
    case {3,4}
      ...
      tic
      result = segmentation_from_superpixels_mean_boundary_value_RAG3(...
  ...
  function run_test()
    ...
    segmentation_from_superpixels_mean_boundary_value_RAG3(...
