function copy_global_patchwise_transforms_from_simple_txt_to_mat_files_m(case_ids)
fprintf('START: copy_global_patchwise_transforms_from_simple_txt_to_mat_files_m\n');
if isdeployed
...
%     save2(fold_mask_output_file_name, 'fold_mask');
    ...
    if(nnz(is_empty_tform)>0)
      ...
      if(isempty(copy_patch))
        transform.transform([1 3],:) = 1;
      else
...
fprintf('STOP: copy_global_patchwise_transforms_from_simple_txt_to_mat_files_m\n');
return
end
