...
function [Learners, Weights, final_hyp] = GentleAdaBoost(WeakLrn, Data, Labels, Max_Iter, relative_error_weight, OldW, OldLrn, final_hyp)
...
if( nargin == 4)
  ...
  relative_error_weight = ones(1, size(Data,2));
...
for It = 1 : Max_Iter
  ...
  %chose best learner
    distr = relative_error_weight.*distr/sum(relative_error_weight.*distr);
