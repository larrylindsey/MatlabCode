...
#ifndef __IPUJ_AGGLO_MERGE_CRITERION_MEAN_BOUNDARY__
#define __IPUJ_AGGLO_MERGE_CRITERION_MEAN_BOUNDARY__
...
namespace seg
{
  class Agglo_Merge_Criterion_Mean_Boundary: public Agglo_Merge_Criterion {
  public:
    Agglo_Merge_Criterion_Mean_Boundary(){}
    ~Agglo_Merge_Criterion_Mean_Boundary(){}
  ...
  private:
    bool 
      initialize_adjacency_statistics_2D__(
        ...
        const Array<Label> * segment_map);
    bool
      initialize_adjacency_statistics_3D__(
        const Array<Boundary_Value> * boundary_map,
        const Array<Label> * segment_map);
...
#endif //__IPU_AGGLO_MERGE_CRITERION_MEAN_BOUNDARY__
