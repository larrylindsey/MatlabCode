function mouse_draw(fig, hAxis, width, height, brush_size, brush_color)
% mouse_draw(fig, hAxis, width, height, brush_size, brush_color)
% draw with mouse like a paint brush
% mouse_draw() initiates the draw behavior
% 
% inputs:
...
props.WindowButtonDownFcn = get(fig, 'WindowButtonDownFcn');
setappdata(fig,'mouse_drag_parent_callbacks_0',props);
set(fig,'WindowButtonDownFcn',{@wbd});
end


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Function called on butten down - starts off drag behavior
% Start accumulating mouse locations into mouse_draw_data.mouse_points
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function wbd(h, evd)
% draw with mouse like a paint brush
% disp('down')
...
setappdata(h,'mouse_drag_parent_callbacks_1',props);
