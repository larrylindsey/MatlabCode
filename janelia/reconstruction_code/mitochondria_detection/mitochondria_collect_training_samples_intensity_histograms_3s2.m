function mitochondria_collect_training_samples_intensity_histograms_3s2(config)
...
version_names{1} = 'heq_intensity_hist_3s2';
version_names{2} = 'intensity_hist_3s2';
...
for case_id = train_config.case_ids
  ...
  [features_mitochondria_1, junk] = compute_neighbor_intensity_histogram(img_1, double(mitochondria_mask), ...
    window_sizes, intensity_bins);
  [features_mitochondria_2, junk] = compute_neighbor_intensity_histogram(img_2, double(mitochondria_mask), ...
    window_sizes, intensity_bins);
  [features_mitochondria_3, junk] = compute_neighbor_intensity_histogram(img_3, double(mitochondria_mask), ...
    window_sizes, intensity_bins);
  ...
  [features_not_mitochondria_1, junk] = compute_neighbor_intensity_histogram(img_1, double(not_mitochondria_mask), ...
    window_sizes, intensity_bins);
  [features_not_mitochondria_2, junk] = compute_neighbor_intensity_histogram(img_2, double(not_mitochondria_mask), ...
    window_sizes, intensity_bins);
  [features_not_mitochondria_3, junk] = compute_neighbor_intensity_histogram(img_3, double(not_mitochondria_mask), ...
    window_sizes, intensity_bins);
