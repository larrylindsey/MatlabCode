function mitochondria_apply_boosted_detector_intensity_hist_3s2(config)
...
for case_id = stack_config.case_ids
  ...
  [test_features_1, sample_loc] = compute_neighbor_intensity_histogram(img_1, double(sample_mask), ...
    window_sizes, intensity_bins);
  [test_features_2, sample_loc] = compute_neighbor_intensity_histogram(img_2, double(sample_mask), ...
    window_sizes, intensity_bins);
  [test_features_3, sample_loc] = compute_neighbor_intensity_histogram(img_3, double(sample_mask), ...
    window_sizes, intensity_bins);
