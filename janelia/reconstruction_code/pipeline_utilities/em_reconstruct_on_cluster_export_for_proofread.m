function em_reconstruct_on_cluster_export_for_proofread(config_param, modes, ...
  varargin)
% em_reconstruct_on_cluster_export_for_proofread(config_param, modes, ...
%   varargin)
...
%   modes                If 1 then run uptil generation of coarse al. These
%                         can be viewed to determine proofreading ROI.
%                       If 2 then runs generation of grayscale maps,
