function config = config_ex_medulla_Leginon_681_684_subset(config, case_ids, ...
  is_verbose, is_verbose_figures)
% config_ex_medulla_Leginon_681_684_subset(config)
% Example of reconstruction configuration for pipeline as of April 21st
% 2009.
...
% v6  04212009  Set the config parameters and return. Called by
%                 em_reconsruct.
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% I. Constants - Best left unchanged
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
config.precompute.boundary.BEL.dump_test_images = true;
...
%%%%%%
% 2.3 For aligning tiles within a section (joint alignment) for stitching
% segmentations
%%%%%%
%%% The following are "reasonable" parameters if using Deformable mesh
% Method to be used for alignment, e.g., 'SIFT', 'deformable_mesh'
...
% config.align.in_section_align.deformable_mesh.optimization.method = 'levenberg_marquadt_rigid';
% Save intermediate files
config.align.in_section_align.deformable_mesh.save = true;
% What to do incase dmesh fails, e.g., due to low overlap
...
config.align.in_section_align.display.display_scale = 5;
...
% Scale images before display
config.align.global_align.display.display_scale = 5;
