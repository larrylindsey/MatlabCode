function seg_boundary_eval_grayscale_ladder_fly_larva_MW_09082008(module_id)
% seg_boundary_eval_grayscale_ladder_fly_larva_MW_09082008(module_id)
% Evaluate segmentation boundary on fly larva MW stack proofread by Satoko
% fly_larva.MW_5SecSeries.rick.09082008
%
% module_id
...
config.DEBUG = false;
% Shiv didn't have permissions to write files in manual_annotations/
% directory 10032008.
config.eval_segment_boundary.annotations_dir = 'manual_annotations_1/';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'fly_larva.MW_5SecSeries.rick.09082008';   
% (b) image name:
...
config.superpixel.area_thresholds = 300;
...
config.superpixel_2_seg.superpixel_suffix = '.gs_l_T0.25_L300.v_heq_mf5'; 
% (c) thresholds on the boundary field
config.superpixel_2_seg.f_thresholds = 0.25:0.05:0.60;
% (d) minimum area of a segment - below this they merged with neighbors
config.superpixel_2_seg.area_thresholds = 300;
...
config.eval_segment_boundary.groundtruth_file = 'proofread.satoko.091008.seg_8h.mat';
...
% the format string.
config.eval_segment_boundary.seg_suffix_format = '.gs_l_sp_T%g_L300.gs_l_T0.25_L300.v_heq_mf5.v_heq_mf5';
