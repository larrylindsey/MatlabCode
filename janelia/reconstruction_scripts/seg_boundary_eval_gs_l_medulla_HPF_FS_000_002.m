function seg_boundary_eval_gs_l_medulla_HPF_FS_000_002(module_id)
% seg_boundary_eval_gs_l_HPF_FS_000_002(module_id)
...
config.superpixel.f_thresholds = 0.51:0.03:0.66;
...
config.superpixel_2_seg.f_thresholds = 0.40:0.01:0.53; %0.46
...
% detection).
config.superpixel_2_seg.filter_version = 'v_heq_mf3_e2'; %'v_heq_mf5_e1';
...
% the format string.
config.eval_segment_boundary.seg_suffix_format = '.gs_l_sp_T%g_L200.gs_l_T0.44_L200.v_heq_mf5_e1_m0_d2_a500.v_heq_mf3_e2'; % '.gs_l_T%g_L200.v_heq_mf5_e1_m0_d2_a500';
config.eval_segment_boundary.seg_suffix_id = 0.48; % config.superpixel_2_seg.f_thresholds; % config.superpixel.f_thresholds;
