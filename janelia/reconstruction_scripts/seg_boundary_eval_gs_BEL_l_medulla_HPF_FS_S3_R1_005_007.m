function seg_boundary_eval_gs_BEL_l_medulla_HPF_FS_S3_R1_005_007(module_id)
% seg_boundary_eval_gs_l_medulla_HPF_FS_S3_R1_005_007_08122008(module_id)
% Evaluate segmentation boundary on
% medulla_HPF_2500x_S3-R1.005_007.
%
% module_id
...
config.superpixel.f_thresholds = 0.47; %[0.4:0.02:0.6];
...
config.superpixel_2_seg.f_thresholds = 0.5; %0.48:0.02:0.64;
...
% detection).
config.superpixel_2_seg.filter_version = 'v_mf5_d1';
...
% the format string.
config.eval_segment_boundary.seg_suffix_format = '.BEL_l_sp_T%g_L100.gs_l_T0.47_L100.v_heq_mf3_e2_m0_d2_a500.5_b_v_mf5_d1';%'.gs_l_T%g_L100.v_heq_mf3_e2_m0_d2_a500'; 
config.eval_segment_boundary.seg_suffix_id = config.superpixel_2_seg.f_thresholds;  %config.superpixel.f_thresholds; 
