function reconstruction_lamina_OTO_3500x_zhiyuan_May232008_elastic_crop(module_id)
...
% ".tif".
config.stack.image_prefix = 'crop.c.%03d'; 
...
config.reconstruction.name = 'reconstruction_lamina.OTO.3500x.zhiyuan.May232008_elastic_crop_v2';
...
config.linkage.train.save_suffix = '.06172008';
...
config.linkage.apply.model_suffix = '.06172008';
...
config.linkage.apply.segmentation_suffix = ... 
  ['.gs_l_sp_T0.45_L150', config.superpixel_2_seg.superpixel_suffix, '.v_heq_e2'];
