function shinya_HPF_bin5000x_001_020(module_id)
% shinya_HPF_bin5000x_001_020(module_id)
% Reconstruction of stack medulla_HPF_5000x(bin)_001_020
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'medulla_HPF_bin5000x_001_020';   
% (b) image name:
...
% case_ids are 6,...,10.
config.mitochondria.train.case_ids = 7:9;
...
% % use superpixel segmentation parameters from previous step
% For grayscale-ladder .gs_l_T<f_threshold>_L<area_threshold>.<filter_version>_<mitochondria m<threshold_d<amount of erosion>>
config.superpixel_2_seg(2).superpixel_suffix = '.gs_amb_sp_T0.63_0.62_b0.gs_l_T0.41_L100.v_heq_mf4_e2_m0_d2_a500.v_heq_mf2';
...
config.superpixel_2_seg(3).superpixel_suffix = '.gs_amdb_sp_T0.65_0.64_b0.gs_amb_sp_T0.63_0.62_b0.gs_l_T0.41_L100.v_heq_mf4_e2_m0_d2_a500.v_heq_mf2.v_heq'; % '.BEL_l_T0.4_L200.5_b_v_mf5_d2'
% (c) thresholds on the boundary field
config.superpixel_2_seg(3).f_threshold_seq = 0.05:0.01:0.1; % :0.02:0.7; % 0.002:0.07;
% () minimum boundary length (pixel units) for two segments to be merged
% should increase with increasing f_thresholds. E.g., 0 for f_thresholds
% <=0.65 and 20 otherwise
...
config.linkage.train.save_suffix = '.08192008';
...
config.linkage.apply.model_suffix = '.08192008';
