function shinya_HPF_FS_S3_R1_005_007_08052008_link_intPairHist(module_id)
% shinya_HPF_FS_S3_R1_005_007_08052008_link_intPairHist(module_id)
% Reconstruction of stack medulla_HPF_2500x_S3-R1.005_007
% based on optimizations performed on ministack. To compare linkage
% features. Linkage feature used: intensity_pair_hist
%
% module_id
...
config.reconstruction.name = '08052008_intPairHist';
...
% mitochondria
config.superpixel.mitochondria_min_area = 100; %500
...
config.superpixel_2_seg.superpixel_suffix = '.gs_l_T0.4_L100.v_heq_mf3_e2_m0_d2_a100'; 
% (c) thresholds on the boundary field
config.superpixel_2_seg.f_thresholds = 0.48; %0.46
...
config.linkage.train.manual_annotation_file = ...
  '/groups/chklovskii/chklovskiilab/electron_microscopy_data/medulla.GA5min_HPF_FS_0509.5000x.zhiyuan.0508-13/manual_annotations/proofread.shinya.07172008.wcat.mat';
% (b) Version name for the linkage model
config.linkage.train.save_suffix = '.08052008';
...
config.linkage.apply.model_suffix = '.08052008';
...
config.linkage.apply.segmentation_suffix = ... 
  ['.gs_l_sp_T0.48_L100', config.superpixel_2_seg.superpixel_suffix, '.v_heq_mf3_e1'];
% (j) Verbose
