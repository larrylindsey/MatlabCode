function seg_boundary_eval_gs_l_medulla_OsO4_8_10(module_id)
...
% the format string.
config.eval_segment_boundary.seg_suffix_format = '.gs_l_T%g_L200.v_heq_mf3_e1_m0_d2';
config.eval_segment_boundary.seg_suffix_id = config.superpixel.f_thresholds(7);
