function mitochondria_recon_ex(module_id)
% mitochondria_recon_ex(module_id)
% Mitochondria detection experiments - recon_ex (HRP Alex volume)
%
% module_id
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'mitochondria_recon_ex';   
% (b) image name:
...
config.reconstruction.name = '04302008';
...
% case_ids are 6,...,10.
config.mitochondria.train.case_ids = [6:(t-1), (t+1):10];
...
config.mitochondria.model.n_iteration = 70;
% (f) Tree depth
