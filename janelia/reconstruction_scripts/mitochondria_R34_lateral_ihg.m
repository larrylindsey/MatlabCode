function config = mitochondria_R34_lateral_ihg(module_id)
% config = mitochondria_R34_lateral_ihg(module_id)
% Mitochondria detection on R34 Lateral images. The intensity histogram
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'mitochondria_R34_lateral';
% (b) image name:
...
% ".tif".
config.stack.image_prefix = 'm.%02d';  
