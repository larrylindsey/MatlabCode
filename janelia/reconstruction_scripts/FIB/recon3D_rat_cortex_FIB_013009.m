function recon3D_rat_cortex_FIB_013009(module_id, case_ids)
% recon3D_rat_cortex_FIB_013009(module_id, case_ids)
% Run the 3D segmentation pipeline (FIB/BF EM) on rat_cortex.FIB.013009
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% name for the reconstruction
config.image_stack.filter_version = 'mf5';
