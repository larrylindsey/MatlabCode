function recon3D_tomo_fly_larva_FIB_11172009(module_id, case_ids)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'tomo_fly_larva_FIB_11172009';   
% (b) image name:
...
% ".tif".
config.stack.image_prefix = 'r.%03d';  
...
config.stack.roi.xmax = 275;
config.stack.roi.ymin = 25;
config.stack.roi.ymax = 275;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% name for the reconstruction
config.image_stack.filter_version = 'mf3';
