function recon3D_tomo_fly_larva_orig_images_1(module_id, case_ids)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'tomo_fly_larva_orig_images_1';   
% (b) image name:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% name for the reconstruction
config.image_stack.filter_version = 'heq_d4_mf8';
