function config = recon3D_lamina_FIB_5x5x5nm_esb_denoised(config, case_ids, is_verbose, is_verbose_figures) %#ok<INUSD>
...
% config.stack.dir = ...
%   '/groups/chklovskii/home/nuneziglesiasj/em_reconstructions/data_em_images/';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'lamina.FIB.5x5x5nm';   
% (b) image name:
...
% ".tif".
config.stack.image_prefix = 'esb_denoised.%04d';  
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% name for the reconstruction
config.image_stack.filter_version = 'mf3_heq';
