...
set stack_name="tomo_fly_larva_30sec_smoothed_11182009"
#set i=1
...
set section_sequence="1 9 10 18 19 27 28 36 37 45 46 54 55 63 64 72 73 81 82 90 91 99 100 108 109 117 118 126 127 135 136 144 145 153 154 162 163 171 172 180 181 189 190 198 199 207 208 216 217 225 226 234 235 243 244 252 253 261 262 270"

#set section_sequence="1 9 10 18 19 27 28 36 37 45 46 54 55 63 64 72 73 81 82 90"

#set section_sequence="1 9 10 18"

set stack_filter="heq_mf3"
set f_threshold_ws=1
set superpixel_suffix=".ws.T$f_threshold_ws"
set s = ($section_sequence)
set f_threshold_ambl=170
set boundary_length_threshold_ambl=50
set minimum_area_threshold_ambl=1000
set f_threshold_seq_ambcs="110 120 130 140 150 160 170 180 190 200"
