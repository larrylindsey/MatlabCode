...
set is_enabled_combined_seeded_agglo_mean_boundary=1
set is_enabled_combined_seeded_agglo_mean_boundary_blend=0

set stack_name="tomo_fly_larva_FIB_orig_11172009"
#set i=1
...
#end
set section_sequence="10 306"

set stack_filter="mf3"
...
set f_threshold_seq_ambcs="120 130 140 150"
