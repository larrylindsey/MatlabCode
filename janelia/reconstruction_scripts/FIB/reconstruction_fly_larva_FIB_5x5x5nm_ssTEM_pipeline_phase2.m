function reconstruction_fly_larva_FIB_5x5x5nm_ssTEM_pipeline_phase2(module_id, case_ids)
...
config.reconstruction.name = '09212009';
...
config.linkage.train.manual_annotation_file = ...
  '/media/FreeAgent_Drive/em_reconstruction/data_em_images/fly_larva.FIB.5x5x5nm/manual_annotations/proofread.victor.wcat.1.15.mat';
...
config.linkage.model.overlap_hist.merge_error_relative_weight = 60;
% Boost classifier for overlap area (across sections)
config.linkage.model.boundary_hist.n_iteration = 40;
config.linkage.model.boundary_hist.tree_depth = 2;
config.linkage.model.boundary_hist.merge_error_relative_weight = 60;
