function recon3D_fly_larva_FIB_D01_5x5x20nm_sn0309_73_061809(module_id, case_ids)
% recon3D_fly_larva_FIB_D01_5x5x20nm_sn0309_73_061809(module_id, case_ids)
% Run the 3D segmentation pipeline (FIB/BF EM) on 
% fly_larva.FIB.D01_5x5x20nm_sn0309_73.061809. Source:
% /groups/hess/hesslab/Neon\ Images/Fly\ Brain/Y2009/M06/D01\ 5x5x20\ nm\
% sample\ #\ 0309-73/
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'fly_larva.FIB.D01_5x5x20nm_sn0309_73.061809';   
% (b) image name:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% name for the reconstruction
config.image_stack.filter_version = 'mf5_heq';
