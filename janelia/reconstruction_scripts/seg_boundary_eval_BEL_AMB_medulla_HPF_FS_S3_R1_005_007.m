function seg_boundary_eval_BEL_l_medulla_HPF_FS_S3_R1_005_007(module_id)
% seg_boundary_eval_BEL_l_medulla_HPF_FS_S3_R1_005_007(module_id)
% Evaluate segmentation boundary on medulla_HPF_2500x_S3-R1.005_007.
% Algorithm: BEL ladder
%
% module_id
...
config.reconstruction.name = 'eval_BEL_ladder';
...
config.superpixel.method = 'grayscale_ladder'; %'BEL_ladder';
% * () version of the boundary
config.superpixel.boundary_version = '5_b';
% (b) thresholds on the boundary field
config.superpixel.f_thresholds = 0.4; % 0.48:0.02:0.56; % 0.3:0.05:0.9;
...
config.superpixel.use_mitochondria = true ;% false;
...
% mitochondria
config.superpixel.mitochondria_min_area = 100;
...
% detection).
config.superpixel.filter_version = 'v_heq_mf3_e2'; %'v_mf5_d3';

%%%%%%%%%%%%%%%%%%%%%%%%%%
% 6. Superpixel to segment
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) Algorithm to be used - must match with the function called
config.superpixel_2_seg.method = 'BEL_ladder';
% (b) Superpixel version to be used as basis
config.superpixel_2_seg.boundary_version = '5_b';
...
config.superpixel_2_seg.superpixel_suffix = '.gs_l_T0.4_L100.v_heq_mf3_e2_m0_d2_a100'; %.BEL_l_T0.5_L100.5_b_v_mf5_d3';
% (c) thresholds on the boundary field
config.superpixel_2_seg.f_thresholds = 0.62 ;% 0.5:0.02:0.66;
% (d) minimum area of a segment - below this they merged with neighbors
config.superpixel_2_seg.area_thresholds = 100; %600
...
% detection).
config.superpixel_2_seg.filter_version = 'v_mf10_d2';
...
config.eval_segment_boundary.method = 'BEL_ladder';
...
% the format string.
config.eval_segment_boundary.seg_suffix_format = '.BEL_l_sp_T%g_L100.gs_l_T0.4_L100.v_heq_mf3_e2_m0_d2_a100.5_b_v_mf10_d2';%'.BEL_l_sp_T%g_L100.BEL_l_T0.5_L100.5_b_v_mf5_d3.5_b_v_mf3_d2';
config.eval_segment_boundary.seg_suffix_id = config.superpixel_2_seg.f_thresholds;
