function seg_boundary_eval_grayscale_ladder_lamina_0_2(module_id)
% seg_boundary_eval_grayscale_ladder_lamina_0_2(module_id)
% Evaluate segmentation boundary on
% lamina.OTO-1-k1.5000x.zhiyuan.Jan222008.0_2.
%
% module_id
...
config.reconstruction.name = 'bootstrap1';
...
config.superpixel.f_thresholds = 0.32;
...
config.superpixel_2_seg.superpixel_suffix = '.gs_l_T0.32_L600.v_heq_mf5_m0_d2_a20'; 
% (c) thresholds on the boundary field
config.superpixel_2_seg.f_thresholds = 0.30:0.02:.5;
...
% detection).
config.superpixel_2_seg.filter_version = 'v_heq_mf5_e2';
...
config.eval_segment_boundary.oversegment_ignore_groundtruth_label = 2490;
...
% the format string.
% config.eval_segment_boundary.seg_suffix_format = '.gs_l_sp_T%g_L600.gs_l_T0.32_L600.v_heq_mf5_m0_d2_a20.v_heq_mf5_e2';
% config.eval_segment_boundary.seg_suffix_id = 0.48; % config.superpixel_2_seg.f_thresholds;
% Parameters used for reconstructing the ministack - for baseline.
config.eval_segment_boundary.seg_suffix_format = '.gs_l_sp_T%g_L600.gs_l_T0.3_L600.v0_m0.5.v0_m0.5';
config.eval_segment_boundary.seg_suffix_id = 0.35;
