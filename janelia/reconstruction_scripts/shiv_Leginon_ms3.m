function shiv_Leginon_ms3(module_id)
% reconstruction_ex_medulla_Leginon_681_683_subset(module_id)
...
% defined in test_681_683_medulla_leginon_quick.xml.
%
% module_id
...
% Whether to precompute correspondences using deformable mesh incase SIFT
% fails
config.align.precompute.deformable_mesh_in_plane_overlap_with_fold.is_enabled = true;

%%%%%%
% 2.2 For aligning a pair of tiles in adjacent sections for linkage for
...
config.align.in_section_align.SIFT.RANSAC.n_iter = 100;
...
% Number of iterations of RANSAC. Transformation with minimum error
% among all iterations is chosen.
config.align.global_align.SIFT.RANSAC.n_iter = 100;
% Initial sample correspondences to be used for RANSAC. Two options:
% * Fixed number of initial sample correspondences used for computing an initial
% estimate of model. Should be greater 2 for affine transformations.
...
config.reconstruction.name = 'medulla_series_3'; %'test_pipeline_v2';
...
config.superpixel(1).save_f_thresholds = 0.45:0.02:0.65; %0.5:0.02:0.6;
