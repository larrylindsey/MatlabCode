function config = mitochondria_lamina_OTO_Jan222008_ih(module_id)
% config = mitochondria_lamina_OTO_Jan222008_ih(module_id)
% Mitochondria detection on Osmium-Lamina images. Use only intensity
% histogram to compare against Gabor filters
%
% module_id
...
% v2  05142008  code borrowed from mitochondria_OsO4_1_medulla_ihg.m
%
...
% * version
config.mitochondria.model.version = '_a';
% * Number of iterations of boosting
config.mitochondria.model.n_iteration = 40;
% * Tree depth
