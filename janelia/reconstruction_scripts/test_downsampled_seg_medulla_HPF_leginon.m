function test_downsampled_seg_medulla_HPF_leginon(module_id)
...
config.stack.image_structure = 'test_0681_0683.xml'; % 'crop.ms.8bit.3500x9x9_0681_0690.xml';
% * slice ids: specify the z-plane numbers.
config.stack.case_ids = 681:683;% :690;
