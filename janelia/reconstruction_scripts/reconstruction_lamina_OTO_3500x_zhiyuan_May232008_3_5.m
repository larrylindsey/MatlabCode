function reconstruction_lamina_OTO_3500x_zhiyuan_May232008_3_5(module_id)
...
config.superpixel_2_seg.superpixel_suffix = '.gs_l_T0.3_L100.v_heq_e1_m0_d5_a20'; 
% (c) thresholds on the boundary field
config.superpixel_2_seg.f_threshold.min = 0.4;
config.superpixel_2_seg.f_threshold.step = 0.01;
config.superpixel_2_seg.f_threshold.max = 0.8;
...
config.linkage.train.save_suffix = '.05292008';
...
config.linkage.apply.model_suffix = '.05292008';
...
config.linkage.apply.segmentation_suffix = ... 
  ['.gs_l_sp_T0.4_L150', config.superpixel_2_seg.superpixel_suffix, '.v_heq_e2'];
