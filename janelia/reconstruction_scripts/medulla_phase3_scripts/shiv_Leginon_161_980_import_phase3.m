function config = shiv_Leginon_161_980_import_phase3(config, case_ids, is_verbose, is_verbose_figures)
...
config.linkage.feature.type = 'intensity_pair_hist_v2c'; %'intensity_pair_hist_v2c';
...
config.linkage.model.type = 'boost'; %'boost';
...
config.linkage.apply.model_suffix = '.06112009'; %'.08062009'; % better to change this into the date you do recon
% (j) Verbose
...
config.proofreader.import.Raveler.to_be_proofread_dir = ...
  '/groups/chklovskii/chklovskiilab/em_reconstruction/data_to_be_proofread/medulla.HPF.Leginon.3500x.zhiyuan.fall2008/region.crop4_global_alignment_0161_1460.161.980.cr14653738440_40/ms3_161.980_combined_stack/';
% Proofread-data directory to which Raveler exported the proofreading.
config.proofreader.import.Raveler.proofread_data_dir = ...
  '/groups/chklovskii/chklovskiilab/em_reconstruction/proofread_data/medulla.HPF.Leginon.3500x.zhiyuan.fall2008/region.crop4_global_alignment_0161_1460.161.980.cr14653738440_40/ms3_161.980_combined_stack_04052010/';
