function config = shiv_Leginon_911_1010_import_phase3(config, case_ids, is_verbose, is_verbose_figures)
...
config.reconstruction.name = 'ms3_911.1010_4k.4k_09042009'; %'ms3_611.710_4k.4k';
...
% config.linkage.apply.delete_linkage_graph_dont_create = true; % put true when you want to delete the files.
...
config.linkage.model.type = 'proofread';
config.linkage.feature.type = 'concatenate_161_1010';
config.linkage.apply.model_suffix = '.v0';
...
config.proofreader.roi.xmin = 6621; %6701;
config.proofreader.roi.ymin = 6510; %6410;
config.proofreader.roi.xmax = 10620; %10700;
config.proofreader.roi.ymax = 10509; %10409;
...
config.proofreader.import.Raveler.to_be_proofread_dir = ...
  '/groups/chklovskii/chklovskiilab/em_reconstruction/data_to_be_proofread/medulla.HPF.Leginon.3500x.zhiyuan.fall2008/region.crop4_global_alignment_0161_1460.911.1010.c364982863240_40/ms3_911.1010_4k.4k_09042009/';
% Proofread-data directory to which Raveler exported the proofreading.
config.proofreader.import.Raveler.proofread_data_dir = ...
  '/groups/chklovskii/chklovskiilab/em_reconstruction/proofread_data/medulla.HPF.Leginon.3500x.zhiyuan.fall2008/region.crop4_global_alignment_0161_1460.911.1010.c364982863240_40/ms3_911.1010_4k.4k_09042009/';
