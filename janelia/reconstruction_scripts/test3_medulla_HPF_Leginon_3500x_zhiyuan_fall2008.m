function test3_medulla_HPF_Leginon_3500x_zhiyuan_fall2008(module_id)
...
config.superpixel(2).superpixel_suffix = '.gs_amb_T0.56_0.55_b0.v_heq_o1_m0_d5_a40.v_heq'; 
% () thresholds on the boundary field
config.superpixel(2).f_thresholds = 0.1;
...
config.superpixel_2_seg(1).superpixel_suffix = '.gs_l_sp_T0.1_L100.gs_amb_T0.56_0.55_b0.v_heq_o1_m0_d5_a40.v_heq.v_heq'; 
% (c) thresholds on the boundary field
config.superpixel_2_seg(1).f_threshold_seq = 0.56:0.01:0.76;
% () thresholds on the boundary field for which segmentations should be
% saved. Useful for reducing disk space.
config.superpixel_2_seg(1).save_f_thresholds = 0.6:0.02:0.76;
% () minimum boundary length (pixel units) for two segments to be merged
% should increase with increasing f_thresholds. E.g., 0 for f_thresholds
% <=0.65 and 20 otherwise
...
% % use superpixel segmentation parameters from previous step
% For grayscale-ladder .gs_l_T<f_threshold>_L<area_threshold>.<filter_version>_<mitochondria m<threshold_d<amount of erosion>>
config.superpixel_2_seg(2).superpixel_suffix = '.gs_amb_sp_T0.66_0.65_b25.gs_l_sp_T0.1_L100.gs_amb_T0.56_0.55_b0.v_heq_o1_m0_d5_a40.v_heq.v_heq.v_heq_mf2';
...
config.superpixel_2_seg(3).superpixel_suffix = ...
  '.gs_amdb_sp_T0.68_0.67_b25.gs_amb_sp_T0.66_0.65_b25.gs_l_sp_T0.1_L100.gs_amb_T0.56_0.55_b0.v_heq_o1_m0_d5_a40.v_heq.v_heq.v_heq_mf2.v_heq';
% (c) thresholds on the boundary field
config.superpixel_2_seg(3).f_threshold_seq = 0.1:0.01:0.3; % :0.02:0.7; % 0.002:0.07;
% () thresholds on the boundary field for which segmentations should be
% saved. Useful for reducing disk space.
