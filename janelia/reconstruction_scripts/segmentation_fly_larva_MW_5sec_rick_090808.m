function segmentation_fly_larva_MW_5sec_rick_090808(module_id)
% segmentation_fly_larva_MW_5sec_rick_090808(module_id)
% 2D segmentation of stack fly_larva.MW_5SecSeries.rick.09082008's 8th
% section for evaluating the preparation.
...
config.superpixel_2_seg(1).superpixel_suffix = '.gs_l_T0.35_L500.v_heq_mf5'; 
% (c) thresholds on the boundary field
config.superpixel_2_seg(1).f_threshold_seq = 0.31:0.01:0.72;
...
% detection).
config.superpixel_2_seg(1).filter_version = 'v_heq_mf4';
% () whether to display intermediate results
...
config.superpixel_2_seg(2).superpixel_suffix = '.gs_amb_sp_T0.71_0.7_b25.gs_l_T0.35_L500.v_heq_mf5.v_heq_mf4';
% (c) thresholds on the boundary field
config.superpixel_2_seg(2).f_threshold_seq = 0.01:0.01:0.07; % :0.02:0.7; % 0.002:0.07;
% () minimum boundary length (pixel units) for two segments to be merged
% should increase with increasing f_thresholds. E.g., 0 for f_thresholds
% <=0.65 and 20 otherwise
