function seg_eval_lamina_3500x_052308_4_5_gs_l_amb(module_id)
% seg_eval_lamina_3500x_052308_4_5_gs_l_amb(module_id)
% Evaluate segmentation on lamina.OTO.3500x.zhiyuan.May232008.3_5 stack
% slices 4 and 5.
% Algorithm: grayscale ladder + agglo. mean boundary
%
% module_id
...
config.superpixel.f_thresholds = 0.30;
...
config.superpixel_2_seg.superpixel_suffix = '.gs_l_T0.3_L100.v_heq_mf2_m0_d5_a40'; 
% (c) thresholds on the boundary field
config.superpixel_2_seg.f_threshold_seq = 0.3:0.01:0.78;
...
config.eval_segment_boundary.groundtruth_file = 'marta.06032008.seg.4_5.mat';
...
% the format string.
config.eval_segment_boundary.seg_suffix_format = '.gs_amb_sp_T%s.gs_l_T0.3_L100.v_heq_mf2_m0_d5_a40.v_heq_mf2';
