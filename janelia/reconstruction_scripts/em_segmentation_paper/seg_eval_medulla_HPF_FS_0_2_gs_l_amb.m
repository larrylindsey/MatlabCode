function seg_eval_medulla_HPF_FS_0_2_gs_l_amb(module_id)
...
config.superpixel.f_thresholds = 0.3:0.05:0.7;
...
config.superpixel_2_seg.superpixel_suffix = '.gs_l_T0.45_L200.v_heq_mf5_e1_m0_d2_a500'; 
% (c) thresholds on the boundary field
config.superpixel_2_seg.f_threshold_seq = 0.45:0.01:0.78;
% () thresholds on the boundary field for which segmentations should be
% saved. Useful for reducing disk space.
config.superpixel_2_seg.save_f_thresholds = 0.6:0.02:0.78;
...
config.eval_segment_boundary.groundtruth_file = 'proofread.shinya.05272008.seg.0_2.mat';
...
% the format string.
config.eval_segment_boundary.seg_suffix_format = '.gs_amb_sp_T%s.gs_l_T0.45_L200.v_heq_mf5_e1_m0_d2_a500.v_heq';
config.eval_segment_boundary.seg_suffix_id =  {};
for i = 0.66:0.02:0.7
  config.eval_segment_boundary.seg_suffix_id{end+1} = ...
    [num2str(i,'%g'),'_',num2str(i-0.01,'%g'),'_b', num2str(25*(i>0.65))];
end
