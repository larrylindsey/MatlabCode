function seg_eval_2007KHApical_s10_subset_gs_l(module_id)
% seg_eval_2007KHApical_s10_subset_gs_l(module_id)
...
% the format string.
config.eval_segment_boundary.seg_suffix_format = '.gs_l_T%g_L200.v_heq_mf2';
