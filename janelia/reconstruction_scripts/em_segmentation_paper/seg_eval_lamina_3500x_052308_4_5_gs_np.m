function seg_eval_lamina_3500x_052308_4_5_gs_np(module_id)
% seg_eval_lamina_3500x_052308_4_5_gs_np(module_id)
% Evaluate segmentation on lamina.OTO.3500x.zhiyuan.May232008.3_5 stack
% slices 4 and 5.
% Algorithm: grayscale non-parametric algorithm
%
% module_id
...
% v5  10312008  comparitive experiments - grayscale nonparametric
%
...
% the format string.
config.eval_segment_boundary.seg_suffix_format = '.gs_np.gs2.nihist2_%d.v2';
