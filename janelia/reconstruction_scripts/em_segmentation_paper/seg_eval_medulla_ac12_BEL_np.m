function seg_eval_medulla_ac12_BEL_np(module_id)
% seg_eval_medulla_ac12_BEL_np(module_id)
% Evaluate segmentation boundary on ac.012 = a.012(801:1600, 801:1600)
...
config.eval_segment_boundary.groundtruth_file = 'region.fs.12.16.fs.12_13_14_15_16/analysis1/katerina.032009/proofread.seg.ac.012.mat';
...
config.eval_segment_boundary.seg_suffix_format = ...
  '.np_sp.v0.a%g.i10000';
config.eval_segment_boundary.seg_suffix_id = 0.5:0.1:1.4;
