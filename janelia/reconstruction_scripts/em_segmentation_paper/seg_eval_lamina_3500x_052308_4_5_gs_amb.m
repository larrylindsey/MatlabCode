function seg_eval_lamina_3500x_052308_4_5_gs_amb(module_id)
% seg_eval_lamina_3500x_052308_4_5_gs_amb(module_id)
...
config.superpixel.save_f_thresholds = 0.66:0.02:0.8;
...
config.superpixel_2_seg.superpixel_suffix = '.gs_amb_T0.8_0.79_b25.v_heq_o1_m0_d5_a40.v_heq'; 
...
% the format string.
config.eval_segment_boundary.seg_suffix_format = '.gs_l_sp_T0.1_L150.gs_amb_T%s.v_heq_o1_m0_d5_a40.v_heq.v_heq_e2';
config.eval_segment_boundary.seg_suffix_id =  {};
for i = 0.66:0.02:0.8
  config.eval_segment_boundary.seg_suffix_id{end+1} = [num2str(i,'%g'),'_',num2str(i-0.01,'%g'),'_b25'];
end
