function seg_eval_medulla_HPF_FS_0_2_gs_nc_l(module_id)
% seg_eval_medulla_HPF_FS_0_2_gs_nc_l(module_id)
...
config.superpixel.f_thresholds = 0.01:0.01:0.1;
...
config.normalized_cuts.n_segments = 80;
...
% the format string.
config.eval_segment_boundary.seg_suffix_format = '.gs_l_T%g_L200.v_ncut_0';
