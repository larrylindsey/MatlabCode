function seg_eval_lamina_3500x_052308_3_5_gs_nc_l(module_id)
% seg_eval_lamina_3500x_052308_3_5_gs_nc_l(module_id)
% Evaluate segmentation on lamina.OTO.3500x.zhiyuan.May232008.3_5 stack
% Algorithm: grayscale + normalized cuts + ladder
%
% module_id
...
config.superpixel.f_thresholds = 0.005:0.001:0.015;
...
% the format string.
config.eval_segment_boundary.seg_suffix_format = '.gs_l_T%g_L100.v_ncut_0';
