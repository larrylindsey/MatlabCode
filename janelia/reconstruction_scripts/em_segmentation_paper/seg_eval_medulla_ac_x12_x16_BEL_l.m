function seg_eval_medulla_ac_x12_x16_BEL_l(module_id)
% seg_eval_medulla_ac_x12_x16_BEL_l(module_id)
...
config.eval_segment_boundary.seg_suffix_id = config.superpixel.f_thresholds(3);
