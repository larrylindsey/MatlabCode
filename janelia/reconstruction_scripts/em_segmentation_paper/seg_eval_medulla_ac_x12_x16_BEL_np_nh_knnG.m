function seg_eval_medulla_ac_x12_x16_BEL_np_nh_knnG(module_id)
% seg_eval_medulla_ac_x12_x16_BEL_np_nh_1nn(module_id)
...
% Algo: BEL + nonparam. agglo. seg. norm. hist. 1-nearest neighbor
%
% module_id
...
config.eval_segment_boundary.seg_suffix_format = ...
  '.np_nh_knnG_sp.v0.gs_l_T0.04_L200.a%g.i10000.BELc_5_mf7.BELc_5_mf7';
config.eval_segment_boundary.seg_suffix_id = 1.2;
