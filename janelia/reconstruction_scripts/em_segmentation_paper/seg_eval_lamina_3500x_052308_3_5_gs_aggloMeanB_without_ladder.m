function seg_eval_lamina_3500x_052308_3_5_gs_aggloMeanB_without_ladder(module_id)
% seg_eval_lamina_3500x_052308_3_5_gs_aggloMeanB_without_ladder(module_id)
% Reconstruction pipeline script for segment boundary evaluation.
% Evaluate on lamina.OTO.3500x.zhiyuan.May232008.3_5 stack.
% Algorithm: grayscale agglomerative clustering mean boundary without
% grayscale ladder for superpixels. Apply agglo-mean-boundary directly on
% watershed.
%
% module_id
...
config.superpixel(1).save_f_thresholds = 0.66:0.02:0.7;
...
config.superpixel(2).superpixel_suffix = '.gs_amb_T0.66_0.65_b25.v_heq_o1_m0_d5_a40.v_heq'; 
% () thresholds on the boundary field
...
config.superpixel_2_seg(1).superpixel_suffix = '.gs_l_sp_T0.1_L150.gs_amb_T0.66_0.65_b25.v_heq_o1_m0_d5_a40.v_heq.v_heq'; 
% (c) thresholds on the boundary field
config.superpixel_2_seg(1).f_threshold_seq = 0.66:0.01:0.9;
% () thresholds on the boundary field for which segmentations should be
% saved. Useful for reducing disk space.
config.superpixel_2_seg(1).save_f_thresholds = 0.7:0.02:0.82;
% () minimum boundary length (pixel units) for two segments to be merged
% should increase with increasing f_thresholds. E.g., 0 for f_thresholds
% <=0.65 and 20 otherwise
...
% % use superpixel segmentation parameters from previous step
% For grayscale-ladder .gs_l_T<f_threshold>_L<area_threshold>.<filter_version>_<mitochondria m<threshold_d<amount of erosion>>
config.superpixel_2_seg(2).superpixel_suffix = '.gs_amb_sp_T0.76_0.75_b25.gs_l_sp_T0.1_L150.gs_amb_T0.66_0.65_b25.v_heq_o1_m0_d5_a40.v_heq.v_heq.v_heq';
