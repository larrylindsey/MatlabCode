function seg_eval_medulla_ac_x12_x16_BEL_np(module_id)
% seg_eval_medulla_ac_x12_x16_BEL_np(module_id)
% Evaluate segmentation boundary on 
% ac.0y = a.0y(801:1600, 801:1600)
% ac.1y = a.0y(801:1600, 1601:2400)
% ac.2y = a.0y(1601:2400, 1601:2400)
% ac.3y = a.0y(1601:2400, 801:1600)
% y = 12, 13, 14, 15, 16
% medulla.HPF.Leginon.3500x.zhiyuan.fall2008.
% Algo: BEL + nonparam. agglo. seg.
%
% module_id
...
config.eval_segment_boundary.method = 'nonparam_agl_seg';
...
%   '.np_sp.v0.a%g.i10000';
% config.eval_segment_boundary.seg_suffix_id = 0.9:0.1:1.3;

% config.eval_segment_boundary.seg_suffix_format = ...
%   '.np_sp.v1.a%g.i10000.BELc_5_mf7.BELc_5_mf7';
% config.eval_segment_boundary.seg_suffix_id = 0.9:0.1:1.3;

% config.eval_segment_boundary.seg_suffix_format = ...
%   '.np_sp.v0.gs_l_T0.04_L200.a%g.i10000.BELc_5_mf7.BELc_5_mf7';
% config.eval_segment_boundary.seg_suffix_id = 0.9:0.1:1.3;

config.eval_segment_boundary.seg_suffix_format = ...
  '.np_sp.v1.gs_l_T0.04_L200.a%g.i10000.BELc_5_mf7.BELc_5_mf7';
config.eval_segment_boundary.seg_suffix_id = 1.3; % 0.9:0.1:1.3;
