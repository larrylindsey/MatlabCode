function seg_eval_BEL_lamina_OTO_3500x_3_5(module_id)
% seg_eval_BEL_lamina_OTO_3500x_3_5(module_id)
...
config.superpixel.f_thresholds = 0.45; % 0.3:0.05:0.9;
% (c) minimum area of a segment - below this they merged with neighbors
config.superpixel.area_thresholds = 0; % 150;
...
% the format string.
config.eval_segment_boundary.seg_suffix_format = '.BEL_l_T%g_L0.4_v_mf5_d2_m0_d2_a500';
config.eval_segment_boundary.seg_suffix_id =  0.45; % config.superpixel.f_thresholds;
