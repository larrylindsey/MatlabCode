function seg_eval_fly_larva_no_ua_10_gs_ws(module_id)
% reconstruction_fly_larva_no_ua_bootstrap2(module_id)
% Evaluation on fly_larva.no_ua.5000xbin2.0_17 stack
% Algorithm: grayscale watershed
%
% module_id
...
config.superpixel.f_thresholds = 0.2:0.05:0.8;
...
% the format string.
config.eval_segment_boundary.seg_suffix_format = '.gs_l_T%g_L0.v_heq_mf5_m2_d10_a1000';
...
config.eval_segment_boundary.is_verbose_figures = false;
