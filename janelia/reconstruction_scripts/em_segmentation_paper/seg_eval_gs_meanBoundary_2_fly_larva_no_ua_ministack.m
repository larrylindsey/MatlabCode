function seg_eval_gs_meanBoundary_2_fly_larva_no_ua_ministack(module_id)
% seg_eval_gs_meanBoundary_fly_larva_no_ua_ministack(module_id)
% Evaluate segmentation boundary on fly larva no_ua
% fly_larva.no_ua.5000xbinx2
%
% module_id
...
% v4  10102008  Modified for grayscale-agglomerative-mean-boundary, etc.
% v5  10122008  Trying another verson of grayscale-agglo.-mean-boundary
%
...
config.superpixel_2_seg(1).superpixel_suffix = '.gs_l_T0.25_L200.v_heq_m2_d10_a1000'; 
% (c) thresholds on the boundary field
config.superpixel_2_seg(1).f_threshold_seq = 0.25:0.01:0.9;
% () thresholds on the boundary field for which segmentations should be
% saved. Useful for reducing disk space.
config.superpixel_2_seg(1).save_f_thresholds = 0.7:0.01:0.9;
...
config.eval_segment_boundary.groundtruth_file = 'wayne.06032008.seg.mat';
...
config.eval_segment_boundary.seg_suffix_format = ...
  '.gs_amb_sp_T%s_b25.gs_l_T0.25_L200.v_heq_m2_d10_a1000.v_heq';
config.eval_segment_boundary.seg_suffix_id = {'0.76_0.75', '0.77_0.76', ...
  '0.78_0.77', '0.79_0.78', '0.8_0.79', '0.81_0.8', '0.82_0.81', '0.83_0.82'};
