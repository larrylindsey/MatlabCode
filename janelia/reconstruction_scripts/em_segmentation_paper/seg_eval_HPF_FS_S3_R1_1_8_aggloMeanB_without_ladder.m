function seg_eval_HPF_FS_S3_R1_1_8_aggloMeanB_without_ladder(module_id)
% seg_eval_HPF_FS_S3_R1_1_8_aggloMeanB_without_ladder(module_id)
% 2D segmentation of stack medulla_HPF_2500x_S3-R1.001_008
% based on Agglo. mean boundary applied directly on watershed with
% grayscale-ladder
%
% module_id
...
config.superpixel_2_seg.superpixel_suffix = '.gs_amb_T0.62_0.61_b0.v_heq_m0_d2_a500'; 
% () thresholds on the boundary field
...
% () Image filtering before performing segmentation (affects boundary
% detection).
config.superpixel_2_seg.filter_version = 'v_heq_e1';
% () whether to display intermediate results
