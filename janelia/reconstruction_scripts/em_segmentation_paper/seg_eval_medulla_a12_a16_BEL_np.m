function seg_eval_medulla_a12_a16_BEL_np(module_id)
% seg_eval_medulla_a12_a16_BEL_np(module_id)
% Evaluate segmentation boundary on a.012 to a.016
% medulla.HPF.Leginon.3500x.zhiyuan.fall2008.
% Algo: BEL + nonparametric agglomerative segmentation
%
% module_id
...
config.eval_segment_boundary.groundtruth_file = 'region.fs.12.16.fs.12_13_14_15_16/analysis1/katerina.032009/proofread.seg.mat';
...
config.eval_segment_boundary.seg_suffix_format = ...
  '.np_sp.v0.a%g.i10000';
config.eval_segment_boundary.seg_suffix_id = 1.0;
