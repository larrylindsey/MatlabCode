function seg_eval_fly_larva_no_ua_10_BEL_amb_l(module_id)
% seg_eval_fly_larva_no_ua_10_BEL_amb_l(module_id)
...
% the format string.
config.eval_segment_boundary.seg_suffix_format = '.gs_l_sp_T0.005_L200%s.BEL_mf7';
config.eval_segment_boundary.seg_suffix_id = config.superpixel(2).superpixel_suffix;
