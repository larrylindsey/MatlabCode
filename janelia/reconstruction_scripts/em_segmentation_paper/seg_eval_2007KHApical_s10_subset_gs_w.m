function seg_eval_2007KHApical_s10_subset_gs_w(module_id)
% seg_eval_2007KHApical_s10_subset_gs_w(module_id)
...
% v4  11252008  seg. eval. for paper
%
...
config.reconstruction.name = 'seg_paper';
...
% the format string.
config.eval_segment_boundary.seg_suffix_format = '.gs_l_T%g_L0.v_heq_mf2';
