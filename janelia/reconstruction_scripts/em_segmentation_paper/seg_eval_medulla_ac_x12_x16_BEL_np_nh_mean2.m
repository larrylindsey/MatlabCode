function seg_eval_medulla_ac_x12_x16_BEL_np_nh_mean2(module_id)
% seg_eval_medulla_ac_x12_x16_BEL_np_nh_mean(module_id)
...
% Algo: BEL + nonparam. agglo. seg. norm. hist. mean value to all samples
%
% module_id
...
% case_ids are 1,2,...,10.
config.stack.case_ids = [012, 112, 212, 312, 013, 113, 213, 313, ...
...
config.eval_segment_boundary.seg_suffix_format = ...
  '.np_nh_mean_sp.v0.d190.gs_l_T0.04_L200.a%g.i10000.BELc_5_mf7.BELc_5_mf7';
config.eval_segment_boundary.seg_suffix_id = 1.0:0.1:1.2; % 0.9:0.1:1.3;
