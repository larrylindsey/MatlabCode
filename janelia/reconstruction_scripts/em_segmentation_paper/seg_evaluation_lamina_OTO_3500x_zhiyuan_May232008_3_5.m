function seg_evaluation_lamina_OTO_3500x_zhiyuan_May232008_3_5(module_id)
...
% (b) thresholds on the boundary field
config.superpixel.f_thresholds = 0.2;
% (c) minimum area of a segment - below this they merged with neighbors
config.superpixel.area_thresholds = 100; % 150;
% (d) Whether mitochondria are to be used to suppress false boundaries
...
config.superpixel_2_seg.f_thresholds = 0.5; % 0.3:0.05:0.8;
...
% the format string.
config.eval_segment_boundary.seg_suffix_format = '.gs_l_T%g_L150.v_heq_e1_m0_d2_a20';
