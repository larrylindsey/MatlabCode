function seg_eval_medulla_HPF_FS_0_2_gs_np(module_id)
...
% the format string.
config.eval_segment_boundary.seg_suffix_format = '.gs_np.gs1.nihist2f1_%g.v2';
config.eval_segment_boundary.seg_suffix_id =  600;
