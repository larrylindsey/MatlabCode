function seg_eval_lamina_3500x_052308_3_5_gs_w(module_id)
% seg_eval_lamina_3500x_052308_3_5_gs_w(module_id)
% Evaluate segmentation on lamina.OTO.3500x.zhiyuan.May232008.3_5 stack
% Algorithm: grayscale watershed (Ladder area threshold = 0)
%
% module_id
...
% the format string.
config.eval_segment_boundary.seg_suffix_format = '.gs_l_T%g_L0.v_heq_e1_m0_d5_a40';
