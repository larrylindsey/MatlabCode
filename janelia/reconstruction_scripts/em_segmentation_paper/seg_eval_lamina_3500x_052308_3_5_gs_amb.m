function seg_eval_lamina_3500x_052308_3_5_gs_amb(module_id)
...
config.superpixel_2_seg.superpixel_suffix = '.gs_l_T0.35_L100.v_heq_e1_m0_d5_a40'; 
% (c) thresholds on the boundary field
config.superpixel_2_seg.f_threshold_seq = 0.35:0.01:0.9;
% () thresholds on the boundary field for which segmentations should be
% saved. Useful for reducing disk space.
config.superpixel_2_seg.save_f_thresholds = 0.72:0.02:0.82;
...
config.eval_segment_boundary.seg_suffix_format = ...
  ['.gs_amb_sp_T%s', config.superpixel_2_seg.superpixel_suffix, '.v_heq'];
s = {};
