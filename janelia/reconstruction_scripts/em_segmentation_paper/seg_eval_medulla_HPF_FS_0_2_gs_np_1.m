function seg_eval_medulla_HPF_FS_0_2_gs_np_1(module_id)
% seg_eval_medulla_HPF_FS_0_2_gs_np(module_id)
% Evaluate segmentation boundary on sec. 0 and 2 of stack
% medulla.GA5min_HPF_FS_0509.5000x.000_002.
% Algo: grayscale nonparametric
%
% module_id
...
config.eval_segment_boundary.method = 'grayscale_nonparam';
...
% the format string.
config.eval_segment_boundary.seg_suffix_format = '.gs_np.gs1.nihist2mf2_%g';
config.eval_segment_boundary.seg_suffix_id =  800;
