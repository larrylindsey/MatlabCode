function seg_eval_medulla_HPF_FS_0_2_crop_bel_nc_amb_l(module_id)
% seg_eval_medulla_HPF_FS_0_2_crop_bel_nc_amb_l(module_id)
...
% Algo: BEL + normalized cuts + ladder
%
% module_id
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'medulla.GA5min_HPF_FS_0509.5000x.000_002.crop.BEL';   
% (b) image name:
...
% the format string.
config.eval_segment_boundary.seg_suffix_format = '.gs_l_sp_T0.0001_L200%s.v_ncut_0_e2';
