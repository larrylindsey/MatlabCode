function test_proofreading_ministack_681_683_12122008(module_id)
...
% v6  12122008  modified for test_proofreading
...
config.stack.image_structure = 'test_proofreading_ministack_681_683.xml';
...
% 1.1. SIFT alignment
%%%%%%%%%%%%%%%%%%%%%%%%%%
config.linkage_align.method = 'SIFT';
...
% a pair of images
config.SIFT.RANSAC.consistency=0.2;
...
config.reconstruction.name = 'test_proof_681_683';
...
config.superpixel(1).save_f_thresholds = [0.55,0.58,0.6]; %0.5:0.02:0.6;
...
config.superpixel(2).superpixel_suffix = '.gs_amb_T0.6_0.59_b0.v_heq_o1_m0_d5_a40.v_heq2'; %'.gs_amb_T0.6_0.59_b0.v_heq_o1_m0_d5_a40.v_heq'; 
% () thresholds on the boundary field
...
config.superpixel(3).superpixel_suffix = ...
  '.gs_l_sp_T0.2_L60.gs_amb_T0.6_0.59_b0.v_heq_o1_m0_d5_a40.v_heq2.v_heq2';
...
config.superpixel_2_seg(1).superpixel_suffix = '.gs_abif_sp_T0.14_0.13_b2.gs_l_sp_T0.2_L60.gs_amb_T0.6_0.59_b0.v_heq_o1_m0_d5_a40.v_heq2.v_heq2.v0'; %'.gs_l_sp_T0.2_L60.gs_amb_T0.6_0.59_b0.v_heq_o1_m0_d5_a40.v_heq2.v_heq2_mf2'; 
% (c) thresholds on the boundary field
config.superpixel_2_seg(1).f_threshold_seq = 0.4:0.01:0.7; %0.4:0.01:0.7;
% () thresholds on the boundary field for which segmentations should be
% saved. Useful for reducing disk space.
config.superpixel_2_seg(1).save_f_thresholds = 0.52:0.02:0.7;
% () minimum boundary length (pixel units) for two segments to be merged
% should increase with increasing f_thresholds. E.g., 0 for f_thresholds
% <=0.65 and 20 otherwise
...
% % use superpixel segmentation parameters from previous step
% For grayscale-ladder .gs_l_T<f_threshold>_L<area_threshold>.<filter_version>_<mitochondria m<threshold_d<amount of erosion>>
config.superpixel_2_seg(2).superpixel_suffix = '.gs_amb_sp_T0.62_0.61_b0.gs_abif_sp_T0.14_0.13_b2.gs_l_sp_T0.2_L60.gs_amb_T0.6_0.59_b0.v_heq_o1_m0_d5_a40.v_heq2.v_heq2.v0.v_heq2';
% '.gs_l_T0.47_L100.v_heq_mf3_e2_m0_d2_a500'; 
% (c) thresholds on the boundary field
config.superpixel_2_seg(2).f_threshold_seq = 0.5:0.01:0.62;
% () thresholds on the boundary field for which segmentations should be
% saved. Useful for reducing disk space.
config.superpixel_2_seg(2).save_f_thresholds = 0.62;
% () minimum boundary length (pixel units) for two segments to be merged
% should increase with increasing f_thresholds. E.g., 0 for f_thresholds
% <=0.65 and 20 otherwise
...
config.superpixel_2_seg(3).superpixel_suffix = ...
  '.gs_amdb_sp_T0.62_0.61_b0.gs_amb_sp_T0.62_0.61_b0.gs_abif_sp_T0.14_0.13_b2.gs_l_sp_T0.2_L60.gs_amb_T0.6_0.59_b0.v_heq_o1_m0_d5_a40.v_heq2.v_heq2.v0.v_heq2.v_heq2';
% (c) thresholds on the boundary field
config.superpixel_2_seg(3).f_threshold_seq = 0.1:0.01:0.5; % :0.02:0.7; % 0.002:0.07;
% () thresholds on the boundary field for which segmentations should be
% saved. Useful for reducing disk space.
config.superpixel_2_seg(3).save_f_thresholds = 0.4:0.02:0.5;
% () minimum boundary length (pixel units) for two segments to be merged
% should increase with increasing f_thresholds. E.g., 0 for f_thresholds
% <=0.65 and 20 otherwise
...
config.linkage.train.save_suffix = '.12122008';
...
config.linkage.apply.model_suffix = '.12122008';
% () The superpixel map to be used for linkage - must match with the
% segmentation being used.
config.linkage.apply.superpixel_method = 'grayscale_AglBIFL';
...
['.gs_abif_sp_T0.5_0.49_b10', config.superpixel_2_seg(end).superpixel_suffix, '.v0'];
% (j) Verbose
