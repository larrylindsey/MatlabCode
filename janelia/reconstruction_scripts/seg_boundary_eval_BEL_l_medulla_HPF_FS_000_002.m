function seg_boundary_eval_BEL_l_medulla_HPF_FS_000_002(module_id)
% seg_boundary_eval_BEL_l_medulla_HPF_FS_000_002(module_id)
% Evaluate segmentation boundary (BEL Ladder) on
...
config.superpixel.boundary_version = '4';
% (b) thresholds on the boundary field
config.superpixel.f_thresholds = 0.55; % 0.3:0.05:0.9;
% (c) minimum area of a segment - below this they merged with neighbors
config.superpixel.area_thresholds = 0;
...
config.eval_segment_boundary.groundtruth_file = 'proofread.shinya.05272008.seg.1_2.mat';
...
% the format string.
config.eval_segment_boundary.seg_suffix_format = '.BEL_l_T%g_L0.4_v_mf5_d2';
