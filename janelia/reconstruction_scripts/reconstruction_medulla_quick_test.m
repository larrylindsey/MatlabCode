function reconstruction_medulla_quick_test(module_id)
% reconstruction_medulla_quick_test(module_id)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'medulla_quick_test';   
% (b) image name:
...
% ".tif".
config.stack.image_prefix = 'ms1 n2-02 5000x-%02d';  
...
config.reconstruction.name = '06022008';
...
config.superpixel.f_thresholds = 0.40:0.02:0.52;
% (c) minimum area of a segment - below this they merged with neighbors
config.superpixel.area_thresholds = 450;
