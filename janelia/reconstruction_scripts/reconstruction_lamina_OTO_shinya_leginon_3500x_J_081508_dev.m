function reconstruction_lamina_OTO_shinya_leginon_3500x_J_081508(module_id)
% reconstruction_lamina_OTO_shinya_leginon_3500x_J_081508(module_id)
% Reconstruction of Lamina: lamina.OTO.shinya.3500x.July2008 J 
%
% module_id
...
config.reconstruction.name = 'test_lamina.J1.3500x.Jun272008';
...
config.superpixel.f_thresholds = [0.30:0.05:0.5];
...
config.superpixel_2_seg.superpixel_suffix = '.gs_l_T0.45_L100.v_heq_e1'; 
% (c) thresholds on the boundary field
config.superpixel_2_seg.f_thresholds = 0.5;
