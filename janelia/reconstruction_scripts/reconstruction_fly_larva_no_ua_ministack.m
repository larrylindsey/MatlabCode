function config = reconstruction_fly_larva_no_ua_ministack(module_id)
% reconstruction_fly_larva_no_ua_ministack(module_id)
% Reconstruction of fly larva no_ua fly_larva.no_ua.5000xbinx2 ministack
%
% module_id
