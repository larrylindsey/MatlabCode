function config = mitochondria_2007KHLateral_s09(module_id)
% config = mitochondria_2007KHLateral_s09(module_id)
...
config.stack.roi.xmin = 1063;
config.stack.roi.xmax = 1925;
config.stack.roi.ymin = 1108;
config.stack.roi.ymax = 1970;
...
% case_ids are 6,...,10.
config.mitochondria.train.case_ids = 52:90;
