function reconstruction_lamina_OTO_Jan222008_ministack(module_id)
...
config.superpixel_2_seg.superpixel_suffix = '.gs_l_T0.3_L600.v0_m0.5'; 
...
% detection).
config.superpixel_2_seg.filter_version = 'v0';
...
config.linkage.apply.segmentation_suffix = ... 
  ['.gs_l_sp_T0.35_L600', config.superpixel_2_seg.superpixel_suffix, '.v0_m0.5'];
