function seg_fly_larva_1st_Instar_brain_test_newPrep(module_id)
...
config.superpixel_2_seg(1).f_threshold_seq = 0.4:0.01:0.8;
% (c) thresholds on the boundary field for which segmentations should be
% saved. Useful for reducing disk space.
config.superpixel_2_seg(1).save_f_thresholds = 0.7:0.01:0.8;
...
% % use superpixel segmentation parameters from previous step
% For grayscale-ladder .gs_l_T<f_threshold>_L<area_threshold>.<filter_version>_<mitochondria m<threshold_d<amount of erosion>>
config.superpixel_2_seg(2).superpixel_suffix = '.gs_amb_sp_T0.77_0.76_b25.gs_l_T0.4_L400.v_heq_mf3.v_heq_mf3';
% '.gs_l_T0.47_L100.v_heq_mf3_e2_m0_d2_a500'; 
% (c) thresholds on the boundary field
config.superpixel_2_seg(2).f_threshold_seq = 0.7:0.01:0.8; 
% 0.48:0.01:0.9;
% (c) thresholds on the boundary field for which segmentations should be
% saved. Useful for reducing disk space.
config.superpixel_2_seg(2).save_f_thresholds = 0.7:0.01:0.8;
% () minimum boundary length (pixel units) for two segments to be merged
% should increase with increasing f_thresholds. E.g., 0 for f_thresholds
% <=0.65 and 20 otherwise
...
% For 1900x
config.superpixel_2_seg(3).superpixel_suffix = '.gs_amdb_sp_T0.79_0.78_b25.gs_amb_sp_T0.77_0.76_b25.gs_l_T0.4_L400.v_heq_mf3.v_heq_mf3.v_heq_mf3';
% (c) thresholds on the boundary field
