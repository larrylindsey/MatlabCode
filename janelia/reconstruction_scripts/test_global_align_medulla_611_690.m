function test_global_align_medulla_611_690(module_id)
% test_global_align_medulla_611_690(module_id)
...
config.stack.image_structure = 'test_global_alignment_0531_0690.xml';
% * slice ids: specify the z-plane numbers.
config.stack.case_ids = 611:690;
...
config.align.global_align.display.save_as_stack_file_name = '~/temp/medulla_align_test_0611_690.tif';
...
config.reconstruction.name = 'test_pipeline_681_690';
...
config.linkage.train.save_suffix = '.01152009';
...
config.linkage.apply.model_suffix = '.01152009';
% (j) Verbose
