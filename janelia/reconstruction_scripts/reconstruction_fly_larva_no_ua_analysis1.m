function reconstruction_fly_larva_no_ua_analysis1(module_id)
% reconstruction_fly_larva_no_ua_analysis1(module_id)
...
config.superpixel_2_seg.superpixel_suffix = '.gs_l_T0.42_L200.v_heq_mf5_m2_d10_a1000'; 
% (c) thresholds on the boundary field
config.superpixel_2_seg.f_thresholds = 0.46:0.03:0.60;
...
config.linkage.train.save_suffix = '.06052008';
...
config.linkage.apply.model_suffix = '.06052008';
...
config.linkage.apply.segmentation_suffix = ... 
  ['.gs_l_sp_T0.55_L200', config.superpixel_2_seg.superpixel_suffix, '.v_heq_mf5_e1'];
...
% the format string.
config.eval_segment_boundary.seg_suffix_format = '.gs_l_sp_T%g_L200.gs_l_T0.42_L200.v_heq_mf5_m2_d10_a1000.v_heq_mf5_e1';
config.eval_segment_boundary.seg_suffix_id = 0.55; % config.superpixel_2_seg.f_thresholds;
