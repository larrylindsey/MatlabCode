function seg_boundary_eval_gs_l_medulla_HPF_FS_S3_R1_005_007(module_id)
...
config.superpixel.f_thresholds = 0.30:0.02:0.8;
...
config.superpixel_2_seg.superpixel_suffix = '.gs_l_T0.5_L100.v_heq_mf3_e2_m0_d2_a500'; 
% (c) thresholds on the boundary field
config.superpixel_2_seg.f_thresholds = 0.47 ;% [0.46:0.01:0.6]; 
...
% detection).
config.superpixel_2_seg.filter_version = 'v_heq_mf3_e1'; %'v_heq_mf5_e1';
...
% the format string.
config.eval_segment_boundary.seg_suffix_format = '.gs_l_T%g_L100.v_heq_mf3_m0_d2_a500';
config.eval_segment_boundary.seg_suffix_id = config.superpixel.f_thresholds(1); % config.superpixel_2_seg.f_thresholds; %config.superpixel.f_thresholds;
