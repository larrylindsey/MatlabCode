function shinya_Leginon_ms3_ver2(module_id, case_ids)
...
config.reconstruction.name = 'ms3_446.455_3.5k.3.5k'; %'test_pipeline_v2';
...
config.linkage.train.save_suffix = '.04212009'; % better to change this into the date you do recon
...
config.linkage.apply.model_suffix = '.04212009'; % better to change this into the date you do recon
% (j) Verbose
...
config.proofreader.roi.xmin = 3937; %3687;
config.proofreader.roi.ymin = 2337; %2087;
config.proofreader.roi.xmax = 7436; %7686;
config.proofreader.roi.ymax = 5836; %6086;
