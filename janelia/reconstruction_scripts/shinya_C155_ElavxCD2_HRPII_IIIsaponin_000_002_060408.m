function shinya_C155_ElavxCD2_HRPII_IIIsaponin_000_002_060408(module_id)
% shinya_HPF_FS_000_002_05192008(module_id)
% Reconstruction of medulla.C155-ElavxCD2-HRPII&IIIsaponin.5000x.000_002 - a mini stack from
% medulla.C155-ElavxCD2-HRPII&IIIsaponin.5000x.zhiyuan.May072008.
%
% module_id
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'medulla.C155-ElavxCD2-HRPII&IIIsaponin.5000x.000_002';   
% (b) image name:
...
config.stack.roi.xmin = 700;
config.stack.roi.xmax = 2100;
config.stack.roi.ymin = 500;
...
config.superpixel.f_thresholds = 0.42;
...
config.superpixel_2_seg.superpixel_suffix = '.gs_l_T0.42_L200.v_heq_mf3_e2_m0_d2_a500'; 
...
config.linkage.train.manual_annotation_file = ...
  '/groups/chklovskii/chklovskiilab/electron_microscopy_data/OsO4-1-medulla-q1_2500x.8_10/manual_annotations/proofread_volume.shinya.05162008.wcat.mat';
