function test_align_lamina_leginon_Je_121908(module_id)
% test_align_lamina_leginon_Je_121908(module_id)
% Test alignment (regularized affine) on lamina leginon J_e stack
%
% module_id
...
config.align.global_align.SIFT.save_as_stack_file_name = '~/temp/lamina_affine_reg.tif';
