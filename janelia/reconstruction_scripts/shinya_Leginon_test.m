function shinya_Leginon_test(module_id)
...
config.stack.image_structure = 'test_0161_0200.xml';
...
config.align.global_align.display.save_as_stack_file_name = '~/temp/medulla_align_c.tif'; %'';
