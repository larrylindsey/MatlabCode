function segmentation_grayscale_ladder_FIB_fly_larva_10272008(module_id)
...
config.superpixel_2_seg.superpixel_suffix = '.gs_l_T0.3_L50.v_heq_mf2';
% (c) thresholds on the boundary field
config.superpixel_2_seg.f_thresholds = 0.55;
% (d) minimum area of a segment - below this they merged with neighbors
config.superpixel_2_seg.area_thresholds = 50;
