function config = debug_shinya_Leginon_161_610_import_proofread(config, case_ids, is_verbose, is_verbose_figures)
...
config.proofreader.roi.xmin = 7251;
config.proofreader.roi.ymin = 6849;
config.proofreader.roi.xmax = 11650;
config.proofreader.roi.ymax = 10648;
...
config.proofreader.import.Raveler.proofread_data_dir = ...
  '/groups/chklovskii/chklovskiilab/em_reconstruction/proofread_data/medulla.HPF.Leginon.3500x.zhiyuan.fall2008/region.crop4_global_alignment_0161_0860.161.610.cr79418336731_40/ms3_161.610_3k.3k_combined_stack/';
