function config = debug_medulla_Leginon_161_980(config, case_ids, is_verbose, is_verbose_figures)
...
config.proofreader.roi.xmin = 9801;
config.proofreader.roi.xmax = 10800;
config.proofreader.roi.ymin = 7801;
config.proofreader.roi.ymax = 8800;
