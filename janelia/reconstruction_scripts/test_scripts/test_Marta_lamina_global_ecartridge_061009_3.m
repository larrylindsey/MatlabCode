function test_Marta_lamina_global_ecartridge_061009_3(module_id, case_ids)
...
config.superpixel(1).mitochondria_erosion = 10;
...
config.superpixel(2).superpixel_suffix = '.gs_amb_T0.64_0.63_b0.v_heq2_mf2_f.v_heq2_mf2';
% (b) thresholds on the boundary field
config.superpixel(2).f_thresholds = 0.25;
% () thresholds on the boundary field for which segmentations should be
% saved. Useful for reducing disk space.
config.superpixel(2).save_f_thresholds = 0.25;
...
% boundaries are not obliterated
config.superpixel(2).mitochondria_erosion = 5;
% * Minimum of a thresholded connected component for it to be considered
% mitochondria
config.superpixel(2).mitochondria_min_area = 500;
