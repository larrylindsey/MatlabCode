function config = debug_medulla_Leginon_10section(config, case_ids, is_verbose, is_verbose_figures)
...
config.proofreader.import.proofread_name = 'concatenate_161_980';
