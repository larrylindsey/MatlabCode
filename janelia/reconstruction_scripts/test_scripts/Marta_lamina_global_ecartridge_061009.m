function Marta_lamina_global_ecartridge_061009(module_id, case_ids)
...
config.superpixel.include_proofread.is_enabled = true;
% proofread name (same as used for config.proofreader.import.proofread_name
config.superpixel.include_proofread.proofread_name = 'proofcomplete';
...
% proofread name (same as used for config.proofreader.import.proofread_name
config.superpixel_2_seg(1).include_proofread.proofread_name = 'proofcomplete';
