function config = debug_shinya_Leginon_611_710_import_proofread(config, case_ids, is_verbose, is_verbose_figures)
...
config.linkage.train.save_suffix = '.08222009'; % better to change this into the date you do recon
...
config.linkage.apply.model_suffix = '.08222009'; % better to change this into the date you do recon
% (j) Verbose
...
config.proofreader.roi.xmin = 7810;
config.proofreader.roi.ymin = 7318;
config.proofreader.roi.xmax = 11809;
config.proofreader.roi.ymax = 11317;
...
config.proofreader.import.Raveler.proofread_data_dir = ...
  '/groups/chklovskii/chklovskiilab/em_reconstruction/proofread_data/medulla.HPF.Leginon.3500x.zhiyuan.fall2008/region.crop4_global_alignment_0161_1460.611.710.cr733050818556_40/ms3_611.710_4k.4k_09042009/';
