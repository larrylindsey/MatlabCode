function config = shiv_Leginon_1281_1310_import(config, case_ids, is_verbose, is_verbose_figures)
...
config.reconstruction.name = 'ms3_1281.1310_4k.4k'; %'ms3_611.710_4k.4k';
...
% config.linkage.include_proofread.proofread_name = '';
...
config.proofreader.roi.xmin = 7751;
config.proofreader.roi.ymin = 6211;
config.proofreader.roi.xmax = 11750;
config.proofreader.roi.ymax = 10210;
config.proofreader.export.is_verbose_figures = false;

config.proofreader.import.proofread_name = 'concatenate_161_1460';
config.proofreader.import.is_verbose = true;
config.proofreader.import.is_verbose_figures = false;
...
config.proofreader.import.Raveler.to_be_proofread_dir = ...
  '/groups/chklovskii/chklovskiilab/em_reconstruction/data_to_be_proofread/medulla.HPF.Leginon.3500x.zhiyuan.fall2008/region.crop4_global_alignment_0161_1460.1281.1310.185929799407_40/ms3_1281.1310_4k.4k/';
config.proofreader.import.Raveler.proofread_data_dir = ...
  '/groups/chklovskii/chklovskiilab/em_reconstruction/proofread_data/medulla.HPF.Leginon.3500x.zhiyuan.fall2008/region.crop4_global_alignment_0161_1460.1281.1310.185929799407_40/shinya.031810.test.import/';
