function test_include_proofread_segment_Alex_volume(module_id, case_ids)
...
config.to_be_proofread.root_dir = ...
  '/opt/home/shiv/research/em_reconstruction/data_to_be_proofread/';
...
config.reconstruction.name = '10012009';
...
config.superpixel.include_proofread.proofread_name = 'test_seg_comb';
...
config.superpixel_2_seg.f_thresholds = 0.6:0.1:0.7;
...
% to load from. The proofread superpixel maps are read with suffix
% [ '.prfrdasp.', config.superpixel.include_proofread.proofread_name];
config.superpixel_2_seg.include_proofread.is_enabled = true;
% proofread name (same as used for config.proofreader.import.proofread_name
config.superpixel_2_seg.include_proofread.proofread_name = 'test_seg_comb';
...
config.linkage.train.manual_annotation_file = ...
  '/opt/home/shiv/research/em_reconstruction/data_em_images/recon_ex/manual_annotations/proofread_6_10.Alex.mat';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% Import data from proofreader
%%%%%%%%%%%%%%%%%%%%%%%%%%
config.proofreader.method = 'Raveler'; %'matlab_gui';
config.proofreader.import.proofread_name = 'test_seg_comb';
