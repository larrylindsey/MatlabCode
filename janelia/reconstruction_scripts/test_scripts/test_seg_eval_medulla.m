function config = test_seg_eval_medulla(config, case_ids, is_verbose, is_verbose_figures)
% test_seg_eval_medulla(config, case_ids, is_verbose, is_verbose_figures)
...
% case_ids are 1,2,...,10.
config.stack.case_ids = case_ids; %7;%:11;
...
config.eval_segment_boundary.method = 'grayscale_ladder';
config.eval_segment_boundary.seg_suffix_format = ...
  '.gs_l_sp_T1e-05_L300.gs_amb_T%s.mf3_m0_d5_a40.mf3.mf3';
config.eval_segment_boundary.seg_suffix_id = {'0.4_0.39_b0'}; % 
