function config = shiv_Leginon_911_1010_import(config, case_ids, is_verbose, is_verbose_figures)
...
config.proofreader.import.proofread_name = 'concatenate_161_1010';
% Print messages
