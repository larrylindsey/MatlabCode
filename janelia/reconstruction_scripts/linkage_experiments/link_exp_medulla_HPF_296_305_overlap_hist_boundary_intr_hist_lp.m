function link_exp_medulla_HPF_296_305_overlap_hist_boundary_intr_hist_lp(module_id, case_ids)
...
config.linkage.model.overlap_hist.n_iteration = 15;
config.linkage.model.overlap_hist.tree_depth = 2;
config.linkage.model.overlap_hist.merge_error_relative_weight = 15;
% Boost classifier for overlap area (across sections)
config.linkage.model.boundary_hist.n_iteration = 40;
config.linkage.model.boundary_hist.tree_depth = 2;
config.linkage.model.boundary_hist.merge_error_relative_weight = 15;
...
config.linkage.evaluate.segmentation_file = ...
  '/groups/chklovskii/medulla/reconstructions/medulla.HPF.Leginon.3500x.zhiyuan.fall2008/2D_segmentation_results/segmentation_stacks_for_linkage_evaluation/seg.wcat.s.region.crop4_global_alignment_0161_0860.296.305.cr928967970826_40.ms3_296.305_3.5k.3.5k.mat';
