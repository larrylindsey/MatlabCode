function link_exp_fly_larva_s_overlap_hist_boundary_intr_hist_lp_TUM(module_id, case_ids)
...
config.linkage.train.manual_annotation_file = ...
  [config.stack.dir, 'fly_larva.no_ua.5000xbinx2.0_17/manual_annotations/proofread.wayne.07142008.wcat.s.mat'];
...
% Whether to include all triangular inequalities
config.linkage.model.LP.all_tri_ineq = false;
config.linkage.model.LP.make_TUM = true;
...
config.linkage.train.save_suffix = [ ...
  ...
  'LP_TUMv5', num2str(config.linkage.model.LP.make_TUM)];
