function link_exp_fly_larva_no_ua_intensity_pair_hist_v2c(module_id, case_ids)
% link_exp_fly_larva_no_ua_joint_opt_lp_p3(module_id)
% Linkage experiments: 
%
% module_id
...
config.linkage.train.save_suffix = '.07292009';
% (c) Type for feature to be used for linkage
config.linkage.feature.type = 'intensity_pair_hist_v2c'; % 'overlap_area' 'normalize_overlap_area';
config.linkage.feature.intensity_bins = 0:0.1:1;
...
config.linkage.apply.model_suffix = '.07292009';
