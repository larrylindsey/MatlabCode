function link_exp_fly_larva_no_ua_s_overlap_area_boundary_hist_lp_p3(module_id, case_ids)
...
config.linkage.train.manual_annotation_file = ...
  '/groups/chklovskii/chklovskiilab/electron_microscopy_data/fly_larva.no_ua.5000xbinx2.0_17/manual_annotations/proofread.wayne.07142008.wcat.s.mat';
...
config.linkage.model.overlap_area.merge_error_relative_weight = 4;
% Boost classifier for overlap area (across sections)
config.linkage.model.boundary_hist.n_iteration = 40;
config.linkage.model.boundary_hist.tree_depth = 2;
config.linkage.model.boundary_hist.merge_error_relative_weight = 4;
...
config.linkage.feature.type = 'overlap_area_boundary_hist';
...
config.linkage.apply.model_suffix = config_ex_medulla_Leginon_681_684_subset.linkage.train.save_suffix;
