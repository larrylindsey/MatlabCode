function recon_fly_larva_no_ua_overlap_hist_bound_intr_lp_p3(module_id)
...
config.reconstruction.name = 'test_linkage_overlap_hist_bound_intr_lp_p3';
...
config.linkage.model.overlap_hist.merge_error_relative_weight = 8;
% Boost classifier for overlap area (across sections)
config.linkage.model.boundary_hist.n_iteration = 40;
config.linkage.model.boundary_hist.tree_depth = 2;
config.linkage.model.boundary_hist.merge_error_relative_weight = 8;
