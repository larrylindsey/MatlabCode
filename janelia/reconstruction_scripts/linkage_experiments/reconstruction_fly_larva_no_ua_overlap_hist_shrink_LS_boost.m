function reconstruction_fly_larva_no_ua_overlap_hist_shrink_LS_boost(module_id, case_ids)
% reconstruction_fly_larva_no_ua_overlap_hist_shrink_LS_boost(module_id)
...
config.linkage.train.manual_annotation_file = ...
  '/groups/chklovskii/home/vitaladevunis/research/em_reconstruction_pipeline/reconstructions/fly_larva.no_ua.5000xbinx2.0_17/2D_segmentation_results/segmentation_for_training_linkage/wcat.gt.3.7.shrink_LS.mat';
...
% Parameters for shrinking the segmentations using level sets
config.linkage.feature.phi_shrink_LS_filter_version = 'BEL5_mul255';
