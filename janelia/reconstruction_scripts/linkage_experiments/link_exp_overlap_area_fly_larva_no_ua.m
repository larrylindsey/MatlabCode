function link_exp_overlap_area_fly_larva_no_ua(module_id, case_ids)
% link_exp_overlap_area_recon_ex(module_id)
% Linkage experiments: 
%
% module_id
...
config.linkage.train.save_suffix = '.1400WithoutAutomaticStopping';
...
config.linkage.apply.model_suffix = '.1400WithoutAutomaticStopping';

%%%
% For k-fold testing of the linkage module
%%%
...
config.linkage.evaluate.segmentation_file = ...
 % '/groups/chklovskii/chklovskiilab/electron_microscopy_data/fly_larva.no_ua.5000xbinx2.0_17/manual_annotations/proofread.wayne.07142008.wcat.mat';
'/groups/chklovskii/home/ghoshp/my_codes/Result_whole_stack/Result_1.5_-0.2_1.2_0_5_0.26_0.15_1400.mat';
% config.linkage.evaluate.k_fold = 2;
% Linkage thresholds to used for generating the
% false-acceptance/false-rejection curves.
config.linkage.evaluate.link_thresholds = -5:1:5;
