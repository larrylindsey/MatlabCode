function link_exp_fly_larva_s_overlap_hist_boundary_intr_hist_ncuts(module_id, case_ids)
...
for rel_wt = [20 18 16 14 12 10 8 6 4 2]
...
config.linkage.model.ncuts.is_only_positive = true;
...
config.linkage.evaluate.link_thresholds = [-(0.0001:0.0001:0.0009), -(0.001:.0005:0.004)];
