function link_exp_fly_larva_no_ua_symm_diff_mean_boundary_lp_p3(module_id, case_ids)
% link_exp_fly_larva_no_ua_symm_diff_mean_boundary_lp_p3(module_id)
% Linkage experiments: 
%
% module_id
...
config.linkage.model.delta = 2500;
config.linkage.model.mean_boundary_threshold = 170;
% (b) Version name for the linkage model
config.linkage.train.save_suffix = [ ...
  'T', num2str(config.linkage.model.mean_boundary_threshold), ...
  'delta', num2str(config.linkage.model.delta)];
% (c) Type for feature to be used for linkage
config.linkage.feature.type = 'symm_diff_mean_boundary';
