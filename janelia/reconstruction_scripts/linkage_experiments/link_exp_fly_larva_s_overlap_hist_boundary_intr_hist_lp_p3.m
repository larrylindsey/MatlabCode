function link_exp_fly_larva_s_overlap_hist_boundary_intr_hist_lp_p3(module_id, case_ids)
...
config.linkage.model.LP.all_tri_ineq = true;
...
config.linkage.train.save_suffix = [ ...
  ...
  'LP', num2str(config.linkage.model.LP.all_tri_ineq)];
