function link_exp_fly_larva_no_ua_symm_diff_lp_p3(module_id, case_ids)
...
config.linkage.model.lambda = 200;
config.linkage.model.min_abs_F_threshold = 0; % 50;
% (b) Version name for the linkage model
config.linkage.train.save_suffix = ['lambda', ...
  num2str(config.linkage.model.lambda), '.e8'];
