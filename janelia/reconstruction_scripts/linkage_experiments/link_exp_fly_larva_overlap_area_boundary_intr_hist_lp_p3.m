function link_exp_fly_larva_overlap_area_boundary_intr_hist_lp_p3(module_id, case_ids)
% link_exp_fly_larva_no_ua_overlap_area_boundary_hist_lp_p3(module_id)
% Linkage experiments: 
%
% module_id
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'fly_larva.no_ua.5000xbinx2.0_17.s';   
% (b) image name:
...
config.linkage.model.overlap_area.n_iteration = 30;
config.linkage.model.overlap_area.tree_depth = 2;
config.linkage.model.overlap_area.merge_error_relative_weight = 2;
% Boost classifier for overlap area (across sections)
config.linkage.model.boundary_hist.n_iteration = 40;
config.linkage.model.boundary_hist.tree_depth = 2;
config.linkage.model.boundary_hist.merge_error_relative_weight = 2;
% (b) Version name for the linkage model
config.linkage.train.save_suffix = [ ...
  num2str(config.linkage.model.overlap_area.n_iteration), '.', ...
  num2str(config.linkage.model.overlap_area.tree_depth), '.', ...
  num2str(config.linkage.model.overlap_area.merge_error_relative_weight), '.', ...
...
config.linkage.feature.type = 'overlap_area_boundary_interior_hist';
...
config.linkage.evaluate.segmentation_file = ...
  '/groups/chklovskii/home/vitaladevunis/research/em_reconstruction_pipeline/reconstructions/fly_larva.no_ua.5000xbinx2.0_17/2D_segmentation_results/grayscale_AglBIFL/wcat.gs_abif_sp_T0.18_0.17_b2.gs_l_sp_T0.1_L200.gs810377897646_40.mat';
%   '/groups/chklovskii/home/vitaladevunis/research/em_reconstruction_pipeline/reconstructions/fly_larva.no_ua.5000xbinx2.0_17/2D_segmentation_results/grayscale_AglBIFL/wcat.s.gs_abif_sp_T0.18_0.17_b2.gs_l_sp_T0.1_L200.333602746673_40.mat';
...
config.linkage.evaluate.link_thresholds = 0:.1:1;
