function link_exp_overlap_area_recon_ex(module_id, case_ids)
...
config.linkage.train.segmentation_file = ...
  '';
...
config.linkage.train.save_suffix = '.06202009';
% (c) Type for feature to be used for linkage
config.linkage.feature.type = 'normalize_overlap_area';%'intensity_pair_hist_v2c'; % 'overlap_area';
...
config.linkage.apply.model_suffix = '.06202009';

%%%
% For k-fold testing of the linkage module
%%%
% % The data is evaluated with a round-robin protocol. It is split into k
...
config.linkage.evaluate.link_thresholds = 0.5; % -5:1:5;
