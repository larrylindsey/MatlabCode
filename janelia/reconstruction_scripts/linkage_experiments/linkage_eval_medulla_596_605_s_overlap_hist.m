function config = linkage_eval_medulla_596_605_s_overlap_hist(config, case_ids, is_verbose, is_verbose_figures)
...
config.reconstruction.name = 'link_eval_oh';
...
% Linkage threshold
config.linkage.apply.linkage_threshold = 1.4;
...
config.linkage.evaluate.linkage_suffix_automatic = ...
  ['.boost.40.2.overlap_hist.10.satoko.042709', config.linkage.evaluate.segment_suffix_automatic];
% Ground-truth segmentation maps to be used for testing.
