function link_exp_fly_larva_overlap_hist_boundary_intr_hist_sdp_2(module_id, case_ids)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'fly_larva.no_ua.5000xbinx2.0_17.s2';   
% (b) image name:
...
config.linkage.model.type = 'boost_sdp';
