function config = linkage_eval_medulla_596_605_s_LDA_lp_shrink_LS(config, case_ids, is_verbose, is_verbose_figures)
...
config.reconstruction.name = 'eval_prfrd_ls_lp_v2';
