function link_exp_fly_larva_no_ua_s_overlap_area_lp_p3(module_id, case_ids)
...
for rel_wt = [26 24 22 20 18 16 14 12 10 8 6 4]
...
config.linkage.model.overlap_area.merge_error_relative_weight = rel_wt;
...
config.linkage.feature.type = 'overlap_area';
