function config = linkage_eval_medulla_596_605_s_LDA_wekarf_lp_shrink_LS(config, case_ids, is_verbose, is_verbose_figures)
...
config.linkage.model.type = 'wekarf_lp_p3';
...
config.linkage.evaluate.linkage_suffix_automatic = ...
  ['.wekarf_lp_p3', config.linkage.model.suffix, ...
