function config = linkage_eval_medulla_596_605_LDA_shrink_LS(config, case_ids, is_verbose, is_verbose_figures)
...
config.linkage.evaluate.linkage_suffix_automatic = ...
  ['.boost.overlap_hist_shrink_LS.40.2', config.linkage.evaluate.segment_suffix_automatic];
...
config.linkage.evaluate.linkage_thresholds = -10; % 0:0.1:2;
