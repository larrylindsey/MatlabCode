function config = medulla_phase4_161_1460_import(config, case_ids, is_verbose, is_verbose_figures)
...
if(nargin>1)
  ...
  config.stack.case_ids = 161:1460;
end
...
config.proofreader.roi.xmin = 6041; %6271;
config.proofreader.roi.ymin = 5871; %5651;
config.proofreader.roi.xmax = 10040; %10270;
config.proofreader.roi.ymax = 9870; %9650;
config.proofreader.export.is_verbose_figures = false;

% Suffix for saving imported data
config.proofreader.import.proofread_name = 'phase4';
% Print messages
...
config.proofreader.import.Raveler.to_be_proofread_dir = ...
  '/groups/chklovskii/chklovskiilab/em_reconstruction/data_to_be_proofread/medulla.HPF.Leginon.3500x.zhiyuan.fall2008/region.crop4_global_alignment_0161_1460.unreal.161788539746303_40/ms3_1011.1110_4k.4k_09042009/';
% Proofread-data directory to which Raveler exported the proofreading.
config.proofreader.import.Raveler.proofread_data_dir = ...
  '/groups/chklovskii/chklovskiilab/em_reconstruction/proofread_data/medulla.HPF.Leginon.3500x.zhiyuan.fall2008/region.crop4_global_alignment_0161_1460.unreal.161788539746303_40/ms3_1011.1110_4k.4k_09042009/';
