function config = medulla_phase4_161_1460_LDA_seeded_watershed_nomito(config, case_ids, is_verbose, is_verbose_figures)
...
% config.superpixel(1).seeded_watershed.seed_filter = ...
%   't0.3_neg_mito0\_e5\_a40_d2_e2_a20'; %%% too adventurous
config.superpixel(1).seeded_watershed.seed_filter = 'mito3\_e10_t0.2_neg_a100_d2';
...
config.linkage.include_proofread.proofread_name = 'phase4';
...
config.proofreader.roi.xmin = 4511;
config.proofreader.roi.ymin = 4311;
...
config.proofreader.annotations.suffix = '.prfrd_adj_annot.phase4';
