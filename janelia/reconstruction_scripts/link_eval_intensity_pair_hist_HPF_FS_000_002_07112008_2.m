function link_eval_intensity_pair_hist_HPF_FS_000_002_07112008_2(module_id)
% link_eval_intensity_pair_hist_HPF_FS_000_002_07112008(module_id)
% Evaluate linkage on medulla.GA5min_HPF_FS_0509.5000x.000_002 - a mini stack from
% medulla.GA5min_HPF_FS_0509.5000x.zhiyuan.0508-13.
% Features are intensity pair histograms, classifier is GentleBoost
%
% module_id
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'medulla.GA5min_HPF_FS_0509.5000x.000_002_2';   
% (b) image name:
...
config.reconstruction.name = '05202008';
...
config.superpixel_2_seg.superpixel_suffix = '.gs_l_T0.44_L200.v_heq_mf5_e1_m0_d2'; 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% 7. 3D linkage graph - training and application
%%%%%%%%%%%%%%%%%%%%%%%%%%
...
config.linkage.train.save_suffix = '.05202008du';
...
config.linkage.evaluate.n_iteration = 1; % 10
