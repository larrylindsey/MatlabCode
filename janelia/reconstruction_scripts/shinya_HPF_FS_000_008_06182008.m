function shinya_HPF_FS_000_008_06182008(module_id)
...
config.reconstruction.name = '06182008';
...
config.linkage.apply.segmentation_suffix = ... 
  ['.gs_l_sp_T0.5_L200', config.superpixel_2_seg.superpixel_suffix, '.v_heq_mf3_e2'];
% (j) Verbose
