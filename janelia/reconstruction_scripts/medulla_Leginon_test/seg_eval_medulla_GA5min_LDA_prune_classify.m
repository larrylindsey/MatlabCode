function config = seg_eval_medulla_GA5min_LDA_prune_classify(config, case_ids, is_verbose, is_verbose_figures)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'medulla.GA5min_HPF_FS_0509.5000x.000_002';   
% (b) image name:
