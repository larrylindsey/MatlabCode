function config = medulla_leginon_align_debug(config, case_ids, is_verbose, is_verbose_figures)
...
if(nargin>1)
  ...
  config.stack.case_ids = 1387:1389;
end
...
config.align.in_section_tile_pair_align.deformable_mesh.params = '-DFT=0.305 -MMA=200000';
...
% Scale images before display
config.align.global_align.display.display_scale = 20; %25;
...
exceptions = {};
exceptions{1,1} = 1409; exceptions{1,2} = '-min_n_matches=0';
config.align.global_align.deformable_mesh.exceptions=exceptions;
