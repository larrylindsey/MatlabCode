function seg_eval_medulla_Leginon_3500x_fall08_misc_BEL_TB6_amb_l_abifl1(module_id)
...
% case_ids are 1,2,...,10.
config.stack.case_ids = 12:16; %:11;
...
config.superpixel(2).f_thresholds = 0.001;
% () thresholds on the boundary field for which segmentations should be
% saved. Useful for reducing disk space.
