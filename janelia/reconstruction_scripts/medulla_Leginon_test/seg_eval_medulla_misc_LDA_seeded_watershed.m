function config = seg_eval_medulla_misc_LDA_seeded_watershed(config, case_ids, is_verbose, is_verbose_figures)
...
% the format string.
config.eval_segment_boundary.method = 'seeded_watershed';
config.eval_segment_boundary.seg_suffix_format = '.sws_0.3_2_20_4_%s_and_APC2_0.35_nm_rev';
config.eval_segment_boundary.seg_suffix_id = {'200'};
