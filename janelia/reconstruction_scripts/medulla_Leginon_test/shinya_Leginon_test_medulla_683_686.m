function config = shinya_Leginon_test_medulla_683_686(config, case_ids, is_verbose, is_verbose_figures)
...
config.reconstruction.name = 'overlap_hist_685.686_083109'; %'test_pipeline_v2';
