function config = shiv_shinya_Leginon_311_610_combine_proofread_stack(config, case_ids, is_verbose, is_verbose_figures)
...
config.reconstruction.name = 'ms3_311.610_3k.3k_combined_stack_new'; %'test_pipeline_v2';
...
config.linkage.include_proofread.proofread_name = 'combination_311_610_3k.3k';
...
config.proofreader.roi.xmin = 4341; %7341;
config.proofreader.roi.ymin = 4876; %6876;
config.proofreader.roi.xmax = 8340; %11340;
config.proofreader.roi.ymax = 8875; %10875;
