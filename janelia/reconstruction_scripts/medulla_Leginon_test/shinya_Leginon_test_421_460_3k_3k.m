function shinya_Leginon_test_421_460_3k_3k(module_id, case_ids)
...
config.reconstruction.name = '042809_421.460_3k.3k';
...
config.linkage.train.save_suffix = '.05012009'; % better to change this into the date you do recon
...
config.linkage.apply.model_suffix = '.05012009'; % better to change this into the date you do recon
% (j) Verbose
...
config.proofreader.roi.xmin = 3120;
config.proofreader.roi.ymin = 2120;
config.proofreader.roi.xmax = 6119;
config.proofreader.roi.ymax = 5119;
