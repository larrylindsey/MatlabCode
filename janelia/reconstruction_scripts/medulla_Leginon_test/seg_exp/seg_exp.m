...
for i = 12:16
  ...
  label_map_n = segment_and(label_map, sg2.label_map, b<0.5, 150);
  ...
  label_map_n2 = segment_and(label_map_n, label_map, b<0.5, 150);
  ...
  save(['~/research/em_reconstruction_pipeline/reconstructions/medulla.HPF.Leginon.3500x.zhiyuan.fall2008/2D_segmentation_results/seeded_watershed/', image_prefix, ...
    '.sws_0.3_2_20_4_200_and_APC2_0.35_nm.mat'], 'label_map');
end