function config = shinya_Leginon_test_medulla_683_686_combine_proofread_stack(config, case_ids, is_verbose, is_verbose_figures)
...
config.stack.dir = '/groups/chklovskii/medulla/';%%% Reconstruction root directory redefinition:
...
config.reconstruction.name = 'test_medulla_683.686_combined_stack'; %'test_pipeline_v2';
...
config.linkage.train.save_suffix = '.08312009';
...
config.linkage.apply.model_suffix = '.08312009';
% (j) Verbose
...
config.linkage.include_proofread.proofread_name = 'combine_test_medulla_683_686'; %'ms3_296.305_3.5k.3.5k';
...
config.proofreader.roi.xmin = 3904; %3704; %4160;
config.proofreader.roi.ymin = 4432; %3832; %2984;
config.proofreader.roi.xmax = 6903; %6703; %7159;
config.proofreader.roi.ymax = 7431; %6831; %5983;
config.proofreader.import.proofread_name = 'combine_test_medulla_683_686'; % the same name is used in the script for combine.
...
config.proofreader.import.Raveler.proofread_data_dir = ...
  '/groups/chklovskii/chklovskiilab/em_reconstruction/proofread_data/test_medulla_stack_1/region.test_medulla_0683_0686.685.686.test_medulla638104236340_40/overlap_hist_685.686_083109/';
