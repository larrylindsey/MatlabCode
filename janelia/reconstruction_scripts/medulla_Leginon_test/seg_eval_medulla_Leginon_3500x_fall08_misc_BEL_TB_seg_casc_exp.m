function seg_eval_medulla_Leginon_3500x_fall08_misc_BEL_TB_seg_casc_exp(module_id)
...
config.eval_segment_boundary.method = 'segment_cascade';
config.eval_segment_boundary.seg_suffix_format = '.seg_cascade_%s';
s = {'exp'};
config.eval_segment_boundary.seg_suffix_id = s;
