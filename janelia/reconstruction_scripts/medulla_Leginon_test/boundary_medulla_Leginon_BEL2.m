function boundary_medulla_Leginon_BEL2(module_id, case_ids)
% boundary_medulla_Leginon_BEL(module_id, case_ids)
% Compute BEL boundary maps for medulla Leginon data.
%
% module_id
...
% case_ids are 1,2,...,10.
config.stack.case_ids = 441:460; % :11;
...
bt(1).minx = 1; bt(1).maxx = 1050; bt(1).miny = 1; bt(1).maxy = 1050;
bt(2).minx = 1; bt(2).maxx = 1050; bt(2).miny = 975; bt(2).maxy = 2000;
bt(3).minx = 975; bt(3).maxx = 2000; bt(3).miny = 975; bt(3).maxy = 2000;
bt(4).minx = 975; bt(4).maxx = 2000; bt(4).miny = 1; bt(4).maxy = 1050;
