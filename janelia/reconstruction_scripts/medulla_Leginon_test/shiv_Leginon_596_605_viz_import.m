function config = shiv_Leginon_596_605_viz_import(config, case_ids, is_verbose, is_verbose_figures)
% config = shiv_Leginon_596_605_import(config, case_ids, is_verbose,
%   is_verbose_figures)
%
% 
% Shiv N. Vitaladevuni
...
config.reconstruction.name = 'viz.satoko.042709';
...
config.linkage.feature.type = 'satoko.042709';
...
config.proofreader.roi.xmin = 6711;
config.proofreader.roi.ymin = 5961;
config.proofreader.roi.xmax = 10760;
config.proofreader.roi.ymax = 9230;
config.proofreader.export.is_verbose_figures = false;

% Suffix for saving imported data
config.proofreader.import.proofread_name = 'satoko.042709';
% Print messages
...
config.proofreader.import.Raveler.to_be_proofread_dir = ...
  '/groups/chklovskii/chklovskiilab/em_reconstruction/data_to_be_proofread/medulla.HPF.Leginon.3500x.zhiyuan.fall2008/region.crop4_global_alignment_0161_0860.596.605.cr928967291924_40/ms3_596.605_3.5k.3.5k/';
...
%   '/groups/chklovskii/chklovskiilab/em_reconstruction/proofread_data/medulla.HPF.Leginon.3500x.zhiyuan.fall2008/region.crop4_global_alignment_0161_1460.1011.1110.185219755301_40/ms3_1011.1110_4k.4k_09042009/export80%/';
...
config.proofreader.import.Raveler.is_numbered_by_depth = false;
