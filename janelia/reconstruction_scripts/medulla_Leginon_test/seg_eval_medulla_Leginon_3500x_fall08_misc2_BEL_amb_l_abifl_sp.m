function seg_eval_medulla_Leginon_3500x_fall08_misc2_BEL_amb_l_abifl_sp(module_id)
% seg_eval_medulla_Leginon_3500x_fall08_misc2_BEL_amb_l_abifl(module_id)
% Evaluate segmentation boundary
% medulla.HPF.Leginon.3500x.zhiyuan.fall2008.seg_eval. 12 to 16
...
config.superpixel(1).save_f_thresholds = 0.05:0.01:0.1;
...
% config.superpixel(1).watershed_filter_version = 'BELc\_5\_mf7_e8_d6';
% () Image filtering before performing segmentation (affects boundary
% detection).
config.superpixel(1).filter_version = 'BELc\_5\_mf7_e2_d1';
...
for f = config.superpixel(1).save_f_thresholds
  s{end+1} = ...
    [ '.gs_amb_T', num2str(f,'%g'), '_', num2str(f-0.01,'%g'), ...
      '_b', num2str(0*(f>0),'%d'), ...
      '.BELc_5_mf7_e2_d1_m0_d5_a40', ...
      '.BELc_5_mf7_e2_d1']; %#ok<AGROW>
end
...
% () Image filtering before performing segmentation (affects boundary
% detection).
config.superpixel(2).filter_version = 'BELc\_5\_mf7_e2_d1';
% () whether to display intermediate results
...
%   '.gs_abif_sp_T0.26_0.25_b20.gs_amdb_sp_T0.18_0.17_b0.gs_amb_T0.18_0.17_b0.BEL_e2_d1.BEL_e2_d1.v0';
% 
