function shinya_Leginon_test(module_id, case_ids)
...
config.reconstruction.name = '042109_446.455_3.5k.3.5k';
...
config.proofreader.roi.xmin = 3937;
config.proofreader.roi.ymin = 2337;
config.proofreader.roi.xmax = 7436;
config.proofreader.roi.ymax = 5836;
