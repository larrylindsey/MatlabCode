function shiv_shinya_Leginon_test(module_id, case_ids)
...
config.precompute.fold.is_enabled = true; %####put true to run(need to do only once)
...
config.superpixel(2).superpixel_suffix = '.gs_amb_T0.55_0.54_b0.v_heq_o1_m0_d5_a40_f.v_heq2'; %'.gs_amb_T0.6_0.59_b0.v_heq_o1_m0_d5_a40.v_heq'; 
% () thresholds on the boundary field
...
config.superpixel(3).superpixel_suffix = ...
  '.gs_l_sp_T0.2_L60.gs_amb_T0.55_0.54_b0.v_heq_o1_m0_d5_a40_f.v_heq2.v_heq2_f';
