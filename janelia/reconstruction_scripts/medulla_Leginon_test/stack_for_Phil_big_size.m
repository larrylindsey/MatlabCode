function config = stack_for_Phil_big_size(config, case_ids, is_verbose, is_verbose_figures)
...
config.region.case_ids = 161:560;
...
config.reconstruction.name = 'big_size_161.171'; %'ms3_611.710_4k.4k';
...
config.proofreader.roi.xmin = 3521;
config.proofreader.roi.ymin = 3621;
config.proofreader.roi.xmax = 12520;
config.proofreader.roi.ymax = 12620;
