function seg_eval_medulla_Leginon_misc_BEL_5tntk_amb_l_abifl(module_id)
...
config.superpixel(1).watershed_filter_version = 'BELc\_5tntk\_mf7_e4_d2';
% () Image filtering before performing segmentation (affects boundary
% detection).
config.superpixel(1).filter_version = 'BELc\_5tntk\_mf7_e4_d2';
...
for f = config.superpixel(1).save_f_thresholds %0.1
  s{end+1} = ...
    [ '.gs_amb_T', num2str(f,'%g'), '_', num2str(f-0.01,'%g'), ...
      '_b', num2str(0*(f>0),'%d'), ...
      '.BELc_5tntk_mf7_e4_d2_m0_d5_a40', ...
      '.BELc_5tntk_mf7_e4_d2']; %#ok<AGROW>
end
...
% () Image filtering before performing segmentation (affects boundary
% detection).
config.superpixel(2).filter_version = 'BELc\_5tntk\_mf7_e4_d2';
% () whether to display intermediate results
...
%       '_b', num2str(0*(f>0),'%d'), ...
%       '.gs_amb_T0.1_0.09_b0', ...
%       '.BELc_tb5_mf7_e4_d2_m0_d5_a40', ...
%       '.BELc_tb5_mf7_e4_d2', ...
%       '.BELc_tb5_mf7_e4_d2']; %#ok<AGROW>
% end
...
% % () Image filtering before performing segmentation (affects boundary
% % detection).
% config.superpixel(3).filter_version = 'BELc\_tb5\_mf7_e4_d2';
% % () whether to display intermediate results
