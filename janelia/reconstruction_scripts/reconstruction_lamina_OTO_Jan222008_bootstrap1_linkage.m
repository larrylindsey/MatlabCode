function reconstruction_lamina_OTO_Jan222008_bootstrap1_linkage(module_id)
% reconstruction_lamina_OTO_Jan222008_bootstrap1_linkage(module_id)
% Lamina-Osmium reconstruction bootstrap1: linkage experiments
%
% module_id
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'lamina.OTO-1-k1.5000x.zhiyuan.Jan222008';   
% (b) image name:
...
config.superpixel_2_seg.f_thresholds = .4;
...
config.linkage.train.manual_annotation_file = ...
  '/groups/chklovskii/chklovskiilab/electron_microscopy_data/lamina.OTO-1-k1.5000x.zhiyuan.Jan222008.0_2/manual_annotations/marta.05052008.wcat.mat';
...
% .gs_l_T<f_threshold>_L<area_threshold>.[superpixel_suffix].<filter_versio
% n>_<mitochondria>
config.linkage.apply.segmentation_suffix = ... 
  ['.gs_l_sp_T0.4_L600', config.superpixel_2_seg.superpixel_suffix, '.v_heq_mf5_e2'];
