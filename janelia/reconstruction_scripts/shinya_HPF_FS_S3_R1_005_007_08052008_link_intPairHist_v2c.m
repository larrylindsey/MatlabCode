function shinya_HPF_FS_S3_R1_005_007_08052008_link_intPairHist_v2c(module_id)
% shinya_HPF_FS_S3_R1_005_007_08052008_link_intPairHist_v2c(module_id)
% Reconstruction of stack medulla_HPF_2500x_S3-R1.005_007
% based on optimizations performed on ministack. To compare linkage
% features. Linkage feature used: intensity_pair_hist_v2c
%
% module_id
...
config.reconstruction.name = '08052008_intPairHist_v2c';
...
config.superpixel_2_seg.superpixel_suffix = '.gs_l_T0.47_L100.v_heq_mf3_e2_m0_d2_a500'; 
...
config.linkage.apply.segmentation_suffix = ... 
  ['.gs_l_sp_T0.48_L100', config.superpixel_2_seg.superpixel_suffix, '.v_heq_mf5_e1'];
% (j) Verbose
