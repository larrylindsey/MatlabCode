function seg_boundary_eval_BEL_l_medulla_HPF_FS_000_002_2(module_id)
...
% detection).
config.superpixel.filter_version = 'v_mf5_d1';
...
% the format string.
config.eval_segment_boundary.seg_suffix_format = '.BEL_l_T%g_L200.5_b_v_mf5_d1';
