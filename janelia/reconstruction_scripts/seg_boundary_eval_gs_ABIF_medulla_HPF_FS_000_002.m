function seg_boundary_eval_gs_ABIF_medulla_HPF_FS_000_002(module_id)
% seg_boundary_eval_gs_ABIF_medulla_HPF_FS_000_002(module_id)
% Evaluate segmentation boundary on
% medulla.GA5min_HPF_FS_0509.5000x.000_002.
% Algorithm: grayscale agglomerative boundary vs interior Fisher Linear
% Discriminant value
%
% module_id
...
% v4  08122008  Modified for medulla HPF FS agglo. boundary vs. interior
%               Fisher Linear Discr.
%
...
config.stack.length_factor = 0.5;
...
% detection).
config.superpixel.filter_version = 'v_mf5_d2';
...
config.superpixel_2_seg.superpixel_suffix = '.gs_amb_sp_T0.63_0.62_b0.gs_l_T0.44_L200.v_heq_mf5_e1_m0_d2_a500.v_heq'; % '.BEL_l_T0.4_L200.5_b_v_mf5_d2'
% (c) thresholds on the boundary field
config.superpixel_2_seg.f_threshold_seq = 0.01:0.01:0.2; % :0.02:0.7; % 0.002:0.07;
...
config.eval_segment_boundary.groundtruth_file = 'proofread.shinya.05272008.seg.mat';
...
% the format string.
config.eval_segment_boundary.seg_suffix_format = '.gs_amb_sp_T%g_0.64_b0.BEL_l_T0.4_L200.5_b_v_mf5_d2.v_heq';
config.eval_segment_boundary.seg_suffix_id = 0.65; % config.superpixel.f_thresholds;
