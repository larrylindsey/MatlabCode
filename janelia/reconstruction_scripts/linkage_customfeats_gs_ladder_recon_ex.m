function linkage_customfeats_gs_ladder_recon_ex(module_id)
% linkage_customfeats_gs_ladder_recon_ex(module_id)
...
%
% AG mod based on reconstruction_ex_Alex_volume.m
% Shiv N. Vitaladevuni
...
config.linkage.train.manual_annotation_file = ...
  '~/data/recon_ex/manual_annotations/proofread_6_10.Alex.mat';
% (b) Version name for the linkage model
config.linkage.train.save_suffix = '.custom7_gsladdder';
...
config.linkage.apply.model_suffix = '.custom7_gsladdder';
