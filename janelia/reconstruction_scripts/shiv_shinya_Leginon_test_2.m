function shiv_shinya_Leginon_test(module_id)
...
config.stack.image_structure = 'test_global_alignment_0161_0280.xml';
% * slice ids: specify the z-plane numbers.
config.stack.case_ids = 210:235;
...
config.align.global_align.display.save_as_stack_file_name = '~/temp/medulla_align_test_0681_690.tif';
...
config.linkage.train.save_suffix = '.01292009';
...
config.linkage.apply.model_suffix = '.01292009';
% (j) Verbose
config.linkage.apply.is_verbose = false;

%%%%%%%%%%%%%%%%%%%%%%%%%%
% 12. Final reconstruction volume
%%%%%%%%%%%%%%%%%%%%%%%%%%
