function config = align_haining_08142009(config, case_ids, is_verbose, is_verbose_figures)
% config = align_haining_08142009(config, case_ids, is_verbose,
%   is_verbose_figures)
%
% 
% Shiv N. Vitaladevuni
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'Haining.08142009';   
% (b) image name:
...
config.stack.image_structure = 'stack.xml';
...
config.align.precompute.SIFT.feature_point.is_verbose_figures = is_verbose_figures;
% Filter images before feeding to SIFT feature point detector. By default
% no filtering or when defined empty.
config.align.precompute.SIFT.feature_point.filter_version = 'mf10_mul8';
...
% Whether to apply a filter on the images before display
config.align.global_align.display.filter_version = 'mul10';
% Scale images before display
