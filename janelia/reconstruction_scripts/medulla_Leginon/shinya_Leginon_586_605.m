function shinya_Leginon_586_605(module_id, case_ids)
...
config.reconstruction.name = 'ms3_586.605_3k.3k'; %'test_pipeline_v2';
...
config.linkage.include_proofread.proofread_name = 'satoko.042709';
