function shinya_Leginon_596_605_new_linkage_test(module_id, case_ids)
...
config.reconstruction.name = 'overlap_hist_596.605_3.5k.3.5k'; %'test_pipeline_v2';
...
config.proofreader.roi.xmin = 2504; %3864;
config.proofreader.roi.ymin = 3496; %3084;
config.proofreader.roi.xmax = 6003; %7363;
config.proofreader.roi.ymax = 6995; %6583;
config.proofreader.import.proofread_name = 'satoko.05112009';
...
config.proofreader.import.Raveler.proofread_data_dir = ...
  '/groups/chklovskii/chklovskiilab/em_reconstruction/proofread_data/medulla.HPF.Leginon.3500x.zhiyuan.fall2008/region.crop4_global_alignment_0161_0860.596.605.cr928967291924_40/ms3_596.605_3.5k.3.5k/satoko.05112009/';
