function shinya_Leginon_161_310(module_id, case_ids)
...
config.reconstruction.name = 'ms3_161.310_3k.3k'; %'test_pipeline_v2';
...
config.linkage.train.save_suffix = '.06142009'; % better to change this into the date you do recon
...
config.linkage.apply.model_suffix = '.06142009'; % better to change this into the date you do recon
% (j) Verbose
