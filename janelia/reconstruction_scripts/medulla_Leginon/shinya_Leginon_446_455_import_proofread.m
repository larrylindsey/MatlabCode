function shinya_Leginon_446_455_import_proofread(module_id, case_ids)
...
config.reconstruction.name = 'ms3_446.455_import_prfrd'; %'test_pipeline_v2';
...
config.align_segmentation.is_verbose_figures = true;
...
config.proofreader.import.proofread_name = 'katerina.042709';
