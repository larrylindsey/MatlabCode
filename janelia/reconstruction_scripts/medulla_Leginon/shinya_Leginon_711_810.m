function config = shinya_Leginon_711_810(config, case_ids, is_verbose, is_verbose_figures)
...
config.reconstruction.name = 'ms3_711.810_4k.4k_09042009'; %'ms3_611.710_4k.4k';
...
config.proofreader.roi.xmin = 6472; %7810; %6490;
config.proofreader.roi.ymin = 6298; %7318; %6310;
config.proofreader.roi.xmax = 10471; %11809; %10489;
config.proofreader.roi.ymax = 10297; %11317; %10309;
