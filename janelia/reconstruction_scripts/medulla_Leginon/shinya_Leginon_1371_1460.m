function config = shinya_Leginon_1371_1460(config, case_ids, is_verbose, is_verbose_figures)
...
config.reconstruction.name = 'ms3_1371.1460_4k.4k'; %'ms3_611.710_4k.4k';
...
config.proofreader.roi.xmin = 7711;
config.proofreader.roi.ymin = 6531;
config.proofreader.roi.xmax = 11710;
config.proofreader.roi.ymax = 10530;
