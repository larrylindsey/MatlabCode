function shinya_Leginon_586_605_import_proofread(module_id, case_ids)
% shinya_Leginon_596_605(module_id)
%
% module_id
...
config.reconstruction.name = 'ms3_586.605_import_prfrd'; %'test_pipeline_v2';
...
config.linkage.train.save_suffix = '.05132009'; % better to change this for the date you do recon
...
config.linkage.apply.model_suffix = '.v0'; % '.05132009'; % better to change this into the date you do recon
% (j) Verbose
...
config.proofreader.roi.xmin = 4504; %3864;
config.proofreader.roi.ymin = 5496; %3084;
config.proofreader.roi.xmax = 8003; %7363;
config.proofreader.roi.ymax = 8995; %6583;
config.proofreader.import.proofread_name = 'ms3_586.605_3k.3k';
...
config.proofreader.import.Raveler.proofread_data_dir = ...
  '/groups/chklovskii/chklovskiilab/em_reconstruction/proofread_data/medulla.HPF.Leginon.3500x.zhiyuan.fall2008/region.crop4_global_alignment_0161_0860.586.605.cr928967291924_40/satoko.060109/ms3_586.605_3k.3k/';
