function config = shinya_Leginon_161_610_combine_proofread_stack(config, case_ids, is_verbose, is_verbose_figures)
...
config.coarse_al.scale = 20; % scale down factor for al_coarse.tif file.
...
% Format in which deformable mesh transformations are stored (.mat or .tif)
...
config.reconstruction.name = 'ms3_161.610_3k.3k_combined_stack'; %'test_pipeline_v2';
...
config.linkage.include_proofread.proofread_name = 'combination_311_610_3k.3k'; % I kept the name as this since 311:460 and 461:610 both have been imported with this name.
...
config.proofreader.roi.xmin = 7251; %7241; %7341;
config.proofreader.roi.ymin = 6849; %6976; %6876;
config.proofreader.roi.xmax = 11650; %11540; %11340;
config.proofreader.roi.ymax = 10648; %10775; %10875;
config.proofreader.import.proofread_name = 'combination_311_610_3k.3k';
...
config.proofreader.import.Raveler.proofread_data_dir = ...
  '/groups/visitors/home/takemurasa/Desktop/Work/311_460_temp_export_satoko.061109/';
