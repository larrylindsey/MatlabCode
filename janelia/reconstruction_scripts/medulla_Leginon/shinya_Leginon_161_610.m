function shinya_Leginon_161_610(module_id, case_ids)
% shinya_Leginon_161_610(module_id)
%
% module_id
...
% Whether to downsample images before display
config.align.global_align.display.display_scale = 40;
...
config.reconstruction.name = 'ms3_161.610_global_align'; %'test_pipeline_v2';
...
config.linkage.train.save_suffix = '.05072009'; % better to change this into the date you do recon
...
config.linkage.apply.model_suffix = '.05072009'; % better to change this into the date you do recon
% (j) Verbose
...
config.proofreader.roi.xmin = 2296; %2504; %3864;
config.proofreader.roi.ymin = 3516; %3496; %3084;
config.proofreader.roi.xmax = 5795; %6003; %7363;
config.proofreader.roi.ymax = 7015; %6995; %6583;
