function config = shinya_Leginon_711_860(config, case_ids, is_verbose, is_verbose_figures)
...
config.reconstruction.name = 'ms3_711.860_3k.3k'; %'test_pipeline_v2';
...
config.proofreader.roi.xmin = 6830; %2504; %3864;
config.proofreader.roi.ymin = 6360; %3496; %3084;
config.proofreader.roi.xmax = 10329; %6003; %7363;
config.proofreader.roi.ymax = 9859; %6995; %6583;
