function quick_test_0241_0244(module_id, case_ids)
% shinya_Leginon_586_605(module_id)
%
% module_id
...
config.stack.image_structure = 'test_0241_0244.xml';
...
config.reconstruction.name = 'quick_test_241_244'; %'test_pipeline_v2';
...
config.linkage.train.save_suffix = '.06102009'; % better to change this into the date you do recon
...
config.linkage.apply.model_suffix = '.06102009'; % better to change this into the date you do recon
% (j) Verbose
...
config.linkage.include_proofread.proofread_name = 'ms3_436.455_3k.3k';
...
config.proofreader.roi.xmin = 7052; %2504; %3864;
config.proofreader.roi.ymin = 7088; %3496; %3084;
config.proofreader.roi.xmax = 10051; %6003; %7363;
config.proofreader.roi.ymax = 10087; %6995; %6583;
