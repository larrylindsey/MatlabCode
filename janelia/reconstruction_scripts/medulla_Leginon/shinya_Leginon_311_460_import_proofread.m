function config = shinya_Leginon_311_460_import_proofread(config, case_ids, is_verbose, is_verbose_figures)
...
config.reconstruction.name = 'ms3_311.460_3k.3k'; %'test_pipeline_v2';
...
config.linkage.train.save_suffix = '.08102009'; % better to change this into the date you do recon
% (c) Type for feature to be used for linkage
config.linkage.feature.type = 'anon'; %'intensity_pair_hist_v2c';
...
config.linkage.model.type = 'proofread'; %'boost';
...
config.linkage.apply.model_suffix = '.v0'; %'.08062009'; % better to change this into the date you do recon
% (j) Verbose
...
config.proofreader.roi.xmin = 7341;
config.proofreader.roi.ymin = 6876;
config.proofreader.roi.xmax = 11340;
config.proofreader.roi.ymax = 10875;
...
config.proofreader.import.Raveler.proofread_data_dir = ...
  '/groups/chklovskii/chklovskiilab/em_reconstruction/proofread_data/medulla.HPF.Leginon.3500x.zhiyuan.fall2008/region.crop4_global_alignment_0161_0860.311.460.cr518277433342_40/ms3_311.460_3k.3k/katerina.061009/';
