function shinya_Leginon_586_595(module_id, case_ids)
% shinya_Leginon_586_595(module_id)
%
% module_id
...
config.reconstruction.name = 'ms3_586.595_3k.3k'; %'test_pipeline_v2';
...
config.proofreader.roi.xmin = 3832; %2504; %3864;
config.proofreader.roi.ymin = 2540; %3496; %3084;
config.proofreader.roi.xmax = 6831; %6003; %7363;
config.proofreader.roi.ymax = 5539; %6995; %6583;
