...
config.reconstruction.name = 'ms3_811.910_4k.4k'; %'test_pipeline_v2';
...
config.proofreader.roi.xmin = 6156; %6472;
config.proofreader.roi.ymin = 5868; %6298;
config.proofreader.roi.xmax = 10155; %10471;
config.proofreader.roi.ymax = 9867; %10297;
