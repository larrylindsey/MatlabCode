function shinya_Leginon_596_605(module_id, case_ids)
...
config.reconstruction.name = 'ms3_596.605_3.5k.3.5k'; %'test_pipeline_v2';
...
config.linkage.train.save_suffix = '.05132009'; % better to change this into the date you do recon
...
config.linkage.apply.model_suffix = '.05132009'; % better to change this into the date you do recon
% (j) Verbose
