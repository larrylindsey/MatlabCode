function shinya_Leginon_296_305_import_proofread(module_id, case_ids)
...
config.proofreader.roi.xmin = 2296; %3864;
config.proofreader.roi.ymin = 3516; %3084;
config.proofreader.roi.xmax = 5795; %7363;
config.proofreader.roi.ymax = 7015; %6583;
config.proofreader.import.proofread_name = 'ms3_296.305_3.5k.3.5k';
...
config.proofreader.import.Raveler.proofread_data_dir = ...
  '/groups/chklovskii/chklovskiilab/em_reconstruction/proofread_data/medulla.HPF.Leginon.3500x.zhiyuan.fall2008/region.crop4_global_alignment_0161_0860.296.305.cr928967970826_40/ms3_296.305_3.5k.3.5k/';
