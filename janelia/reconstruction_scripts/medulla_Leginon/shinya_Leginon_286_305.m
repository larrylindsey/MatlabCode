function shinya_Leginon_286_305(module_id, case_ids)
...
config.reconstruction.name = 'ms3_286.305_3k.3k'; %'test_pipeline_v2';
...
config.linkage.train.save_suffix = '.05262009'; % better to change this into the date you do recon
...
config.linkage.apply.model_suffix = '.05262009'; % better to change this into the date you do recon
% (j) Verbose
...
config.linkage.include_proofread.proofread_name = 'satoko.042709'; %put the name of directory of exported data
...
config.proofreader.roi.xmin = 6484; %2504; %3864;
config.proofreader.roi.ymin = 6804; %3496; %3084;
config.proofreader.roi.xmax = 9483; %6003; %7363;
config.proofreader.roi.ymax = 9803; %6995; %6583;
