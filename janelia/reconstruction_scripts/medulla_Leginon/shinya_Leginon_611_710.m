function config = shinya_Leginon_611_710(config, case_ids, is_verbose, is_verbose_figures)
...
config.reconstruction.name = 'ms3_611.710_4k.4k_08222009'; %'ms3_611.710_4k.4k';
...
config.proofreader.roi.xmin = 7810; %6490;
config.proofreader.roi.ymin = 7318; %6310;
config.proofreader.roi.xmax = 11809; %10489;
config.proofreader.roi.ymax = 11317; %10309;
