function shinya_Leginon_296_305(module_id, case_ids)
% shinya_Leginon_296_305(module_id)
%
% module_id
...
config.reconstruction.name = 'ms3_296.305_3.5k.3.5k'; %'test_pipeline_v2';
...
config.linkage.train.save_suffix = '.04262009'; % better to change this into the date you do recon
...
config.linkage.apply.model_suffix = '.04262009'; % better to change this into the date you do recon
% (j) Verbose
