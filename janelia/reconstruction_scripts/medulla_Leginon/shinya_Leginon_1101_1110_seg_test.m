function config = shinya_Leginon_1101_1110_seg_test(config, case_ids, is_verbose, is_verbose_figures)
...
config.reconstruction.name = 'ms3_1101.1110'; %'ms3_611.710_4k.4k';
