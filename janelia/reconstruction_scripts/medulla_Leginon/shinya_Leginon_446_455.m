function shinya_Leginon_446_455(module_id, case_ids)
% shinya_Leginon_446_455(module_id)
%
% module_id
...
% config.align.in_section_align.display.display_scale = 20; %10
...
config.proofreader.roi.xmin = 4504;
config.proofreader.roi.ymin = 3180; 
config.proofreader.roi.xmax = 8003; 
config.proofreader.roi.ymax = 6679; 
