function shinya_Leginon_436_445(module_id, case_ids)
% shinya_Leginon_436_445(module_id)
%
% module_id
...
config.reconstruction.name = 'ms3_436.455_3k.3k'; %'test_pipeline_v2';
...
config.linkage.train.save_suffix = '.04292009'; % better to change this into the date you do recon
...
config.linkage.apply.model_suffix = '.04292009'; % better to change this into the date you do recon
% (j) Verbose
...
config.linkage.include_proofread.proofread_name = 'katerina.042709';
...
config.proofreader.roi.xmin = 6164; %3832;
config.proofreader.roi.ymin = 6972; %2540;
config.proofreader.roi.xmax = 9163; %6831;
config.proofreader.roi.ymax = 9971; %5539;
