function superpixel_cluster_gt_gs_l_medulla_HPF_FS_001_triplet(module_id)
% superpixel_cluster_gt_gs_l_medulla_HPF_FS_001_triplet(module_id)
% Compute very high recall superpixel map for generating ground truth
% segmentation for a single section. medulla.GA5min_HPF_FS_0509.5000x.000_002.
%
% module_id
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'medulla.GA5min_HPF_FS_0509.5000x.001_triplet';   
% (b) image name:
...
config.superpixel.f_thresholds = 0.4; % from precision recall curve
...
config.superpixel_2_seg.superpixel_suffix = '.gs_l_T0.4_L200.v_heq_mf5_e1'; 
% (c) thresholds on the boundary field
config.superpixel_2_seg.f_thresholds = 0.2;
...
config.linkage.apply.segmentation_suffix = ... 
  ['.gs_l_sp_T0.2_L100', config.superpixel_2_seg.superpixel_suffix, '.v_heq_mf5_e2'];
