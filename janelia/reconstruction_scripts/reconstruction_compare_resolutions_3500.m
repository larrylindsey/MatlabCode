function reconstruction_compare_resolutions_3500(module_id)
...
% ".tif".
config.stack.image_prefix = 'redmag_%4d'; % 'ls-1 f5-01-1 3500x-%1d';
config.stack.image_suffix = '.tif';
% (c) slice ids: If the images are a001.tif, ..., a010.tif then the
% case_ids are 1,2,...,10.
config.stack.case_ids =3500:3500;%1:1;
...
config.superpixel.mitochondria_erosion = 7; % 20
...
config.superpixel_2_seg.superpixel_suffix = '.gs_l_T0.3_L100.v_heq_e1_m0_d7_a20'; 
...
% boundaries are not obliterated
config.superpixel_2_seg.mitochondria_erosion = 7;
