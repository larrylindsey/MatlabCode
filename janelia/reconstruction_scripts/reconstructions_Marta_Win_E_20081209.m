function reconstructions_Marta_Win_E_20081209(module_id)
...
config.stack.dir = 'E:/';
config.to_be_proofread.root_dir = 'C:/users/Marta/em_reconstruction/data_to_be_proofread/';
config.proofreading_session.root_dir = 'C:/users/Marta/em_reconstruction/proofreading_sessions/';
...
config.SIFT.save_as_stack_file_name = '';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'E'; % 'lamina.OTO.shinya.leginon.3500x.July2008';   
% (b) image name:
...
config.stack.image_structure = 'Ecartridge_ewin.xml';
% * slice ids: specify the z-plane numbers.
config.stack.case_ids = 0:22;
...
config.reconstruction.name = '20081209';
...
config.superpixel_2_seg.superpixel_suffix = '.gs_l_T0.56_L600.v_heq_mf10_m0_d-1_a500'; 
...
config.linkage.train.manual_annotation_file = ...
  'C:/users/Marta/em_reconstruction/data_em_images/recon_ex/manual_annotations/proofread_6_10.Alex.mat';
...
config.linkage.apply.superpixel_suffix = config.superpixel_2_seg.superpixel_suffix;
