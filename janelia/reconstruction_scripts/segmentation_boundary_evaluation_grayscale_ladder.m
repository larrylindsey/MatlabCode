function segmentation_boundary_evaluation_grayscale_ladder(module_id)
...
config.segmentation_2D.f_thresholds = 0.4:0.04:0.9;
...
config.segmentation_2D.mitochondria_erosion = -1;
...
% detection).
config.segmentation_2D.filter_version = 'v_heq';
...
% the format string.
config.eval_segment_boundary.seg_suffix_format = '.gs_l_T%g_L400.v_heq_m0_d-1';
config.eval_segment_boundary.seg_suffix_id = 0.6; % config.segmentation_2D.f_thresholds;
