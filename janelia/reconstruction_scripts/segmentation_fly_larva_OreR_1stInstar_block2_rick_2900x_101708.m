function segmentation_fly_larva_PreR_1stInstar_block2_rick_2900x_101708(module_id)
% segmentation_fly_larva_PreR_1stInstar_block2_rick_2900x_101708(module_id)
% 2D segmentation of stack
% fly_larva.OreR_1stInstar_block2.rick.101708 at 2900x
%
...
% v7  10172008  test fly_larva.OreR_1stInstar_block2.2900x.rick.101708
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'fly_larva.OreR_1stInstar_block2.rick.101708';   
% (b) image name:
...
% ".tif".
% config.stack.image_prefix = '27932B1.Section%d.2900x.dm3';  
config.stack.image_prefix = '26154K%d.2900x.dm3';  
config.stack.image_suffix = '.tif';
% (c) slice ids: If the images are a001.tif, ..., a010.tif then the
% case_ids are 1,2,...,10.
config.stack.case_ids = 5;
...
config.superpixel.f_thresholds = 0.3:0.05:0.5;
...
% config.superpixel_2_seg(1).superpixel_suffix = '.gs_l_T0.3_L100.v_heq'; % 2900x
config.superpixel_2_seg(1).superpixel_suffix = '.gs_l_T0.35_L200.v_heq'; % 1900x
% (c) thresholds on the boundary field
config.superpixel_2_seg(1).f_threshold_seq = 0.35:0.01:0.9;
...
% For 1900x
config.superpixel_2_seg(2).superpixel_suffix = '.gs_amb_sp_T0.68_0.67_b25.gs_l_T0.3_L50.v_heq_e1.v_heq_mf2';
% (c) thresholds on the boundary field
...
% () Image filtering before performing segmentation (affects boundary
% detection).
config.superpixel_2_seg(2).filter_version = 'v_mf5';
% () whether to display intermediate results
