function seg_boundary_eval_gs_MeanBoundary_fly_larva_MW_090808(module_id)
% seg_boundary_eval_gs_MeanBoundary_fly_larva_MW_090808(module_id)
...
config.superpixel_2_seg.f_threshold_seq = 0.25:0.01:0.9;
% () thresholds on the boundary field for which segmentations should be
% saved. Useful for reducing disk space.
config.superpixel_2_seg(1).save_f_thresholds = 0.68:0.02:0.8;
