function seg_boundary_eval_gs_l_medulla_HPF_FS_S3_R1_005_007_08122008(module_id)
...
config.superpixel_2_seg.f_thresholds = 0.48; %[0.3:0.02:0.44]; %[0.4:0.02:0.52]; 
% (d) minimum area of a segment - below this they merged with neighbors5
...
% the format string.
config.eval_segment_boundary.seg_suffix_format = '.gs_l_sp_T%g_L100.gs_l_T0.47_L100.v_heq_mf3_e2_m0_d2_a500.v_heq_mf5_e1'; %'.gs_l_T%g_L100.v_heq_mf3_e2_m0_d2_a500'; 
