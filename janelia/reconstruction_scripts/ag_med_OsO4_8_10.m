function ag_med_OsO4_8_10(module_id)
% shinya_OsO4_8_10_04292008(module_id)
% Reconstruction of OsO4-1-medulla-q1_2500x.8_10 - a mini stack from
...
% 
% AG based on shinya_OsO4_8_10_04292008.m
% Shiv N. Vitaladevuni
...
config.stack.align.xg_save_name = 'save.xg';
config.stack.align.margin = 200;
config.stack.align.roi = [];
config.stack.align.roi_file_name = 'align_roi.mat';  %AG
...
config.reconstruction.name = 'ag05222008';
...
config.superpixel_2_seg.superpixel_suffix = '.gs_l_T0.41_L200.v_heq_mf3_e1_m0_d2'; 
% (c) thresholds on the boundary field
config.superpixel_2_seg.f_thresholds = 0.45; %0.58
...
% detection).
config.superpixel_2_seg.filter_version = 'v_heq_mf3_e2';
...
config.linkage.train.manual_annotation_file = ...
  '~/data/OsO4-1-medulla-q1_2500x.8_10/manual_annotations/proofread_volume.shinya.05162008.seg.mat';
config.linkage.train.roi.ymin = 1;
config.linkage.train.roi.ymax = 1000;
% (b) Version name for the linkage model
config.linkage.train.save_suffix = '.custom7_s_gsladdder';
% (c) Type for feature to be used for linkage
config.linkage.feature.type = 'custom7_s';
...
config.linkage.apply.model_suffix = '.custom7_s_gsladdder';
...
config.linkage.apply.segmentation_suffix = ... 
  ['.gs_l_sp_T0.45_L400', config.superpixel_2_seg.superpixel_suffix, '.v_heq_mf3_e2'];
% (j) Verbose
config.linkage.apply.is_verbose = true;
...
config.evaluate_volume.groundtruth_file = ...
  'proofread_volume.shinya.05162008.seg.mat'; %~/data/OsO4-1-medulla-q1_2500x.8_10/manual_annotations/
config.evaluate_volume.roi.ymin = 1001;
config.evaluate_volume.roi.ymax = 2133;
