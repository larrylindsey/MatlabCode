function shinya_HPF_FS_005_007_07152008(module_id)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'medulla_HPF_2500x_S3-R1.005_007_2';   
% (b) image name:
...
config.superpixel_2_seg.superpixel_suffix = '.gs_l_T0.44_L100.v_heq_mf5_e1_m0_d2_a500'; 
% (c) thresholds on the boundary field
config.superpixel_2_seg.f_thresholds = 0.5; %0.46
...
config.linkage.train.save_suffix = '.07152008b';
...
config.linkage.apply.model_suffix = '.07152008b';
...
config.linkage.apply.segmentation_suffix = ... 
  ['.gs_l_sp_T0.5_L100', config.superpixel_2_seg.superpixel_suffix, '.v_heq_mf3_e1'];
% (j) Verbose
...
config.linkage.evaluate.n_iteration = 10;
...
% () Should the segment pairs be saved for observation
config.linkage.evaluate.is_link_dumped = false;
