function shinya_HPF_3500x_unbin_T1_T3_01_19(module_id)
% shinya_HPF_3500x_unbin_T1_T3_19(module_id)
% Reconstruction of stack medulla_HPF_3500x_unbin_T1_T3_01_19
...
% v8  09032008  code taken from takemuras/shinya_HPF_3500x_unbin_T1_T3.m
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'medulla_HPF_3500x_unbin_T1_T3_01_19';   
% (b) image name:
...
config.reconstruction.name = '09052008';
...
config.superpixel_2_seg(1).length_threshold_seq = ...
  6 + 19*(config.superpixel_2_seg(1).f_threshold_seq>0.65);
...
% % use superpixel segmentation parameters from previous step
% For grayscale-ladder .gs_l_T<f_threshold>_L<area_threshold>.<filter_version>_<mitochondria m<threshold_d<amount of erosion>>
config.superpixel_2_seg(2).superpixel_suffix = '.gs_amb_sp_T0.62_0.61_b6.gs_l_T0.41_L100.v_heq_mf4_e2_m0_d2_a500.v_heq_mf2';
% '.gs_l_T0.47_L100.v_heq_mf3_e2_m0_d2_a500'; 
% (c) thresholds on the boundary field
config.superpixel_2_seg(2).f_threshold_seq = 0.5:0.01:0.7; 
% 0.48:0.01:0.9;
% () minimum boundary length (pixel units) for two segments to be merged
% should increase with increasing f_thresholds. E.g., 0 for f_thresholds
% <=0.65 and 20 otherwise
...
config.superpixel_2_seg(3).superpixel_suffix = '.gs_amdb_sp_T0.65_0.64_b0.gs_amb_sp_T0.62_0.61_b6.gs_l_T0.41_L100.v_heq_mf4_e2_m0_d2_a500.v_heq_mf2.v_heq';
% (c) thresholds on the boundary field
config.superpixel_2_seg(3).f_threshold_seq = 0.01:0.01:0.1; % :0.02:0.7; % 0.002:0.07;
% () minimum boundary length (pixel units) for two segments to be merged
% should increase with increasing f_thresholds. E.g., 0 for f_thresholds
% <=0.65 and 20 otherwise
...
config.linkage.train.save_suffix = '.09052008';
...
config.linkage.apply.model_suffix = '.09052008';
...
config.linkage.apply.segmentation_suffix = ... 
  ['.gs_abif_sp_T0.02_0.01_b10', config.superpixel_2_seg(end).superpixel_suffix, '.v_mf2']; % '.v_mf5_d1'
% (j) Verbose
