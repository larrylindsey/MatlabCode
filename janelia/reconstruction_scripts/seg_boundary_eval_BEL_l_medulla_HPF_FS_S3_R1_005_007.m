...
config.superpixel.method = 'BEL_ladder'; %'BEL_ladder';
% * () version of the boundary
config.superpixel.boundary_version = '5_b';
% (b) thresholds on the boundary field
config.superpixel.f_thresholds = 0.48; %0.48:0.02:0.56; %0.16:0.02:0.34; % 0.3:0.05:0.9;
...
% detection).
config.superpixel.filter_version = 'v_mf10'; %'v_mf5_d3';
...
config.superpixel_2_seg.superpixel_suffix = '.BEL_l_T0.48_L100.5_b_v_mf10'; %.gs_l_T0.4_L100.v_heq_mf3_e2_m0_d2_a100;
% (c) thresholds on the boundary field
config.superpixel_2_seg.f_thresholds = 0.54; %0.48:0.02:0.64;
...
% detection).
config.superpixel_2_seg.filter_version = 'v_mf5';
...
% the format string.
config.eval_segment_boundary.seg_suffix_format = '.BEL_l_sp_T%g_L100.BEL_l_T0.48_L100.5_b_v_mf10.5_b_v_mf5_d1'; %'.BEL_l_T%g_L100.5_b_v_mf10'; 
config.eval_segment_boundary.seg_suffix_id = config.superpixel_2_seg.f_thresholds; %config.superpixel.f_thresholds; %config.superpixel_2_seg.f_thresholds;
