function seg_boundary_eval_gs_AMdB_medulla_HPF_FS_S3_R1_005_007(module_id)
% seg_boundary_eval_gs_AMdB_medulla_HPF_FS_S3_R1_005_007(module_id)
% Evaluate segmentation boundary on
% medulla_HPF_2500x_S3-R1.005_007. Algo.: agglomerative clustering on
% median boundary values
%
% module_id
...
% v5  08132008  Modified for agglo. median boundary value
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) Algorithm to be used - must match with the function called
config.superpixel_2_seg.method = 'grayscale_AglMedianB';
% () Superpixel method
...
config.superpixel_2_seg.superpixel_suffix = '.gs_amb_sp_T0.7_0.69_b25.gs_l_T0.41_L100.v_heq_mf3_e2_m0_d2_a500.v_heq';
% '.gs_l_T0.47_L100.v_heq_mf3_e2_m0_d2_a500'; 
% (c) thresholds on the boundary field
config.superpixel_2_seg.f_threshold_seq = 0.69:0.01:0.9; 
% 0.48:0.01:0.9;
...
% the format string.
config.eval_segment_boundary.seg_suffix_format = '.gs_amdb_sp_T%g_0.76_b25.gs_amb_sp_T0.7_0.69_b25.gs_l_T0.47_L100.v_heq_mf3_e2_m0_d2_a500.v_heq.v_heq';
% '.gs_amdb_sp_T%g_0.7_b25.gs_l_T0.47_L100.v_heq_mf3_e2_m0_d2_a500.v_heq';
config.eval_segment_boundary.seg_suffix_id = 0.77;
% 0.71
