function seg_boundary_eval_gs_AMB_medulla_HPF_FS_000_002(module_id)
% seg_boundary_eval_gs_AMB_medulla_HPF_FS_000_002(module_id)
% Evaluate segmentation boundary on
% medulla.GA5min_HPF_FS_0509.5000x.000_002.
% Algorithm: grayscale agglomerative mean boundary value
%
% module_id
...
config.superpixel_2_seg.superpixel_suffix = '.BEL_l_T0.4_L200.5_b_v_mf5_d2'; % '.gs_l_T0.44_L200.v_heq_mf5_e1_m0_d2_a500'; 
% (c) thresholds on the boundary field
config.superpixel_2_seg.f_threshold_seq = 0.5:0.01:0.9;
...
% detection).
config.superpixel_2_seg.filter_version = 'v_heq';
