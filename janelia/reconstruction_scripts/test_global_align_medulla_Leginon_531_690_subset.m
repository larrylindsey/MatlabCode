function test_global_align_medulla_Leginon_531_690_subset(module_id)
% test_global_align_medulla_Leginon_531_690_subset(module_id)
% Test global alignment on medulla Leginon stack
%
% module_id
...
config.align.global_align.display.save_as_stack_file_name = '~/temp/test_global_align_0531_0690.tif';
...
config.reconstruction.name = 'test_pipeline_v2';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% 10. Output datastructures to trakEM
%%%%%%%%%%%%%%%%%%%%%%%%%%
