function segmentation_fly_larva_carbon_thickness_120808_22am_b(module_id)
% segmentation_fly_larva_carbon_thickness_120808_22am_b(module_id)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'carbon_thickness_tests_120808_2.2nm';   
% (b) image name:
