function segmentation_leginon_test_fly_larva_Spirit_2900x_Retest(module_id)
% segmentation_leginon_test_fly_larva_Spirit_2900x_Retest(module_id)
% 2D segmentation of stack leginon_tests_fly_larva_Spirit_2900x_Retest to
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'leginon_tests_fly_larva_Spirit_2900x_Retest';
% (b) image name:
...
% ".tif".
config.stack.image_prefix = '09jan14a_279852N2_4800x_00008gr_%05dex';  
config.stack.image_suffix = '.tif';
% (c) slice ids: If the images are a001.tif, ..., a010.tif then the
% case_ids are 1,2,...,10.
config.stack.case_ids = 699;
...
config.superpixel_2_seg(2).superpixel_suffix = ...
  '.gs_amb_sp_T0.72_0.71_b25.gs_l_T0.44_L150.v_heq_mf3.v_heq_mf3';
% (c) thresholds on the boundary field
