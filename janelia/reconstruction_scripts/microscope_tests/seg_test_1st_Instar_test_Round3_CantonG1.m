function seg_test_1st_Instar_test_Round3_CantonG1(module_id, case_ids)
% seg_test_1st_Instar_test_Round3_CantonS6(module_id)
% 2D segmentation of stack 1st_Instar_Test.Round3.06162009/CantonS6/
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = '1st_Instar_Test.Round3.06162009';   
% (b) image name:
