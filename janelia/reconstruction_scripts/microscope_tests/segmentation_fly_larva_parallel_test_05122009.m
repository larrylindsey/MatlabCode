...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'fly_larva.parallel_test.05122009';   
% (b) image name:
...
% ".tif".
config.stack.image_prefix = '09may07a_27891G3_i001_00009gr_00031sq_%05dex';  
config.stack.image_suffix = '.tif';
% (c) slice ids: If the images are a001.tif, ..., a010.tif then the
% case_ids are 1,2,...,10.
config.stack.case_ids = 6;
...
config.superpixel.f_thresholds = 0.35; % 0.3:0.1:0.7;
...
config.superpixel_2_seg(1).save_f_thresholds = 0.7:0.01:0.85;
