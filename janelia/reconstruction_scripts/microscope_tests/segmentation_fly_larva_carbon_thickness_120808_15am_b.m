function segmentation_fly_larva_carbon_thickness_120808_15am_b(module_id)
% segmentation_fly_larva_carbon_thickness_120808_08nm_b(module_id)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'carbon_thickness_tests_120808_1.5nm';   
% (b) image name:
...
config.superpixel_2_seg(1).superpixel_suffix = '.gs_l_T0.3_L150.v_heq'; % 4800x
% (c) thresholds on the boundary field
config.superpixel_2_seg(1).f_threshold_seq = 0.3:0.01:0.8;
% (c) thresholds on the boundary field for which segmentations should be
% saved. Useful for reducing disk space.
config.superpixel_2_seg(1).save_f_thresholds = 0.6:0.02:0.8;
...
% For 1900x
config.superpixel_2_seg(2).superpixel_suffix = '.gs_amb_sp_T0.68_0.67_b25.gs_l_T0.3_L150.v_heq.v_heq_mf3';
% (c) thresholds on the boundary field
