function segmentation_leginon_spirit_carbon_sat_15amC(module_id)
% segmentation_leginon_spirit_carbon_sat_15amC(module_id)
% 2D segmentation of stack leginon_spirit_carbon.sat.1.5nmC to
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'leginon_spirit_carbon.sat.1.5nmC';
% (b) image name:
...
% ".tif".
config.stack.image_prefix = '09jan14a_27986U1.1.5nm_00004gr_%05dex';  
config.stack.image_suffix = '.tif';
% (c) slice ids: If the images are a001.tif, ..., a010.tif then the
% case_ids are 1,2,...,10.
config.stack.case_ids = 28;
