function seg_Round2_1stInstar_Test_DualFix_pUAc(module_id)
% seg_Round2_1stInstar_Test_DualFix_pUAc(module_id)
% 2D segmentation of stack Round2_1stInstar_Test_DualFix_+UAc for
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'Round2_1stInstar_Test_DualFix_+UAc';   
% (b) image name:
...
% ".tif".
config.stack.image_prefix = '27894A1.Section1.5000X.%d';  
...
config.superpixel.f_thresholds = 0.5; % 0.3:0.1:0.7;
...
config.superpixel_2_seg(1).save_f_thresholds = 0.8:0.01:0.85;
