function segmentation_leginon_test_fly_larva_Spirit_2900x_halfSat0(module_id)
% segmentation_leginon_test_fly_larva_Spirit_2900x_Retest(module_id)
% 2D segmentation of stack leginon_tests_fly_larva_Spirit_2900x_halfSat0 to
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'leginon_tests_fly_larva_Spirit_2900x_halfSat0';
% (b) image name:
...
% ".tif".
config.stack.image_prefix = '09jan14a_279852N3.5.2900_00004gr_%05dex';  
config.stack.image_suffix = '.tif';
% (c) slice ids: If the images are a001.tif, ..., a010.tif then the
% case_ids are 1,2,...,10.
config.stack.case_ids = 98;
...
config.superpixel_2_seg(2).superpixel_suffix = ...
  '.gs_amb_sp_T0.74_0.73_b25.gs_l_T0.42_L150.v_heq_mf3.v_heq_mf3';
% (c) thresholds on the boundary field
