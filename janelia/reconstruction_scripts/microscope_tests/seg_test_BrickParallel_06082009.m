function seg_test_BrickParallel_06082009(module_id)
% seg_test_BrickParallel_06082009(module_id)
% 2D segmentation of stack BrickParallel for
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'BrickParallel';   
% (b) image name:
...
config.stack.image_structure = 'Marta/BrickParallel.xml';
...
config.superpixel_2_seg(1).save_f_thresholds = 0.74; %:0.01:0.8;
