function segmentation_cam_test_010809_bin_1_vs_2(module_id)
% segmentation_cam_test_010809_bin_1_vs_2(module_id)
% 2D segmentation of stack carbon_thickness_tests_120808_2.2nm for
% evaluating EM camera. Bin 1 vs. bin 2.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'cam_test_010809_Spirit_ShutterConfiguration';   
% (b) image name:
...
% ".tif".
config.stack.image_prefix = '27932M1.bin%d.NoC.2900x'; % '27932M1.bin%d.NoC.4800x';  
...
config.superpixel.area_thresholds = 75; % 150
...
% config.superpixel_2_seg(1).superpixel_suffix = '.gs_l_T0.46_L150.v_heq_mf2'; % 4800xbin1
% config.superpixel_2_seg(1).superpixel_suffix = '.gs_l_T0.38_L75.v_heq_mf2'; % 4800xbin2
config.superpixel_2_seg(1).superpixel_suffix = '.gs_l_T0.42_L75.v_heq_mf2'; % 2900xbin1
% (c) thresholds on the boundary field
config.superpixel_2_seg(1).f_threshold_seq = 0.42:0.01:0.9;
...
%   '.gs_amb_sp_T0.78_0.77_b25.gs_l_T0.46_L150.v_heq_mf2.v_heq_mf2'; % 4800xbin1
% config.superpixel_2_seg(2).superpixel_suffix = ...
%   '.gs_amb_sp_T0.76_0.75_b25.gs_l_T0.38_L75.v_heq_mf2.v_heq_mf2'; % 4800xbin2
config.superpixel_2_seg(2).superpixel_suffix = ...
  '.gs_amb_sp_T0.76_0.75_b25.gs_l_T0.42_L75.v_heq_mf2.v_heq_mf2'; % 2900xbin1
% (c) thresholds on the boundary field
