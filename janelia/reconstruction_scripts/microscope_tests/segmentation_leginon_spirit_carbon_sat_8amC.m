function segmentation_leginon_spirit_carbon_sat_8amC(module_id)
% segmentation_leginon_spirit_carbon_sat_8amC(module_id)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'leginon_spirit_carbon.sat.0.8nmC';
% (b) image name:
...
% ".tif".
config.stack.image_prefix = '09jan14a_27986T1.0.8nm_00012gr_%05dex';  
config.stack.image_suffix = '.tif';
% (c) slice ids: If the images are a001.tif, ..., a010.tif then the
% case_ids are 1,2,...,10.
config.stack.case_ids = 133;
...
config.superpixel_2_seg(1).superpixel_suffix = ...
  '.gs_l_T0.38_L150.v_heq_mf3.v_heq_mf3';
% (c) thresholds on the boundary field
config.superpixel_2_seg(1).f_threshold_seq = 0.38:0.01:0.9;
...
config.superpixel_2_seg(2).superpixel_suffix = ...
  '.gs_amb_sp_T0.72_0.71_b25.gs_l_T0.38_L150.v_heq_mf3.v_heq_mf3.v_heq_mf3';
% (c) thresholds on the boundary field
