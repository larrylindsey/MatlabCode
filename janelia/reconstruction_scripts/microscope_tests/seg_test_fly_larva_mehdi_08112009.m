function seg_test_fly_larva_mehdi_08112009(module_id, case_ids)
% seg_test_fly_larva_mehdi_08112009(module_id)
% 2D segmentation of stack data_em_images/fly_larva.mehdi_tests.08112009.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'fly_larva.mehdi_tests.08112009';   
% (b) image name:
...
config.stack.image_prefix = 'Cut%d.1';  
...
% config.stack.image_structure = 'CantonA1.xml';
...
config.reconstruction.name = '08112009';
...
config.superpixel.f_thresholds = 0.55;
% (c) minimum area of a segment - below this they merged with neighbors
config.superpixel.area_thresholds = 40;
...
% detection).
config.superpixel.filter_version = 'aheq_mf3';
% () whether to print messages
config.superpixel.is_verbose = true;
% () whether to display intermediate results
config.superpixel.is_verbose_figures = true;
...
config.superpixel_2_seg(1).superpixel_suffix = ...
  '.gs_l_T0.55_L40.aheq_mf3.aheq_mf3';
% (c) thresholds on the boundary field
config.superpixel_2_seg(1).f_threshold_seq = 0.55:0.01:0.84;
% (c) thresholds on the boundary field for which segmentations should be
% saved. Useful for reducing disk space.
config.superpixel_2_seg(1).save_f_thresholds = 0.74:0.01:0.84;
...
% detection).
config.superpixel_2_seg(1).filter_version = 'aheq_mf3';
% () whether to print messages
config.superpixel_2_seg(1).is_verbose = true;
% () whether to display intermediate results
config.superpixel_2_seg(1).is_verbose_figures = true;
...
% () Image filtering before performing segmentation (affects boundary
% detection).
config.superpixel_2_seg(2).filter_version = 'aheq_mf3';
% () whether to display intermediate results
config.superpixel_2_seg(2).is_verbose = true;
% () whether to display intermediate results
config.superpixel_2_seg(2).is_verbose_figures = true;
