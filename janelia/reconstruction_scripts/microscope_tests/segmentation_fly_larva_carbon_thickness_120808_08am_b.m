function segmentation_fly_larva_carbon_thickness_120808_08am_b(module_id)
% segmentation_fly_larva_carbon_thickness_120808_08am_b(module_id)
...
% For 1900x
config.superpixel_2_seg(2).superpixel_suffix = '.gs_amb_sp_T0.74_0.73_b25.gs_l_T0.3_L150.v_heq.v_heq';
% (c) thresholds on the boundary field
