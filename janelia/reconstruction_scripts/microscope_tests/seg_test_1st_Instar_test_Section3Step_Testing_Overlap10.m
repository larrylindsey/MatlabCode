function seg_test_1st_Instar_test_Section3Step_Testing_Overlap10(module_id, case_ids)
% seg_test_1st_Instar_test_Section3Step_Testing_Overlap10(module_id)
% 2D segmentation of stack 1st_Instar_Test.Section3Step_Testing.Overlap10 for
% evaluating the Leginon brick pattern imaging on the fly larva.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = '1st_Instar_Test.Section3Step_Testing.Overlap10';   
% (b) image name:
...
config.stack.image_structure = 'Rick10/10percent.xml';
...
config.superpixel.f_thresholds = 0.45; % 0.3:0.05:0.5;
...
config.superpixel_2_seg(1).superpixel_suffix = ...
  '.gs_l_T0.45_L200.aheq_mf3.aheq_mf3';
% (c) thresholds on the boundary field
config.superpixel_2_seg(1).f_threshold_seq = 0.45:0.01:0.74;
