function segmentation_leginon_test_fly_larva_Spirit_4800x_15amC_bin2(module_id)
% segmentation_leginon_test_fly_larva_Spirit_4800x_15amC_bin2(module_id)
% 2D segmentation of stack leginon_tests_fly_larva_Spirit_4800x_1.5nmC_bin2 to
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'leginon_tests_fly_larva_Spirit_4800x_1.5nmC_bin2';
% (b) image name:
...
% ".tif".
config.stack.image_prefix = '09jan14a_27932O4bin2_00008gr_%05dex';  
config.stack.image_suffix = '.tif';
% (c) slice ids: If the images are a001.tif, ..., a010.tif then the
% case_ids are 1,2,...,10.
config.stack.case_ids = 24;
...
config.superpixel_2_seg(1).superpixel_suffix = ...
  '.gs_l_T0.4_L150.v_heq_mf2';
% (c) thresholds on the boundary field
config.superpixel_2_seg(1).f_threshold_seq = 0.4:0.01:0.9;
...
config.superpixel_2_seg(2).superpixel_suffix = ...
  '.gs_amb_sp_T0.78_0.77_b25.gs_l_T0.4_L150.v_heq_mf2.v_heq_mf2';
% (c) thresholds on the boundary field
