function segmentation_leginon_test_fly_larva_T20_3500x_bin1(module_id)
% segmentation_leginon_test_fly_larva_T20_3500x_bin1(module_id)
% 2D segmentation of stack leginon_test_fly_larva_T20_3500x_bin1 to
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'leginon_tests_fly_larva_T20_3500x_bin1';   
% (b) image name:
...
% ".tif".
config.stack.image_prefix = '09jan14b_27932M2bin1_00006gr_%05dex';  
config.stack.image_suffix = '.tif';
% (c) slice ids: If the images are a001.tif, ..., a010.tif then the
% case_ids are 1,2,...,10.
config.stack.case_ids = 120;
...
config.superpixel_2_seg(2).superpixel_suffix = ...
  '.gs_amb_sp_T0.78_0.77_b25.gs_l_T0.42_L200.v_heq_mf2.v_heq_mf2';
% (c) thresholds on the boundary field
