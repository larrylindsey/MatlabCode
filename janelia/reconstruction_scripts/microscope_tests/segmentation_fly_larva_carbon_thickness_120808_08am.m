function segmentation_fly_larva_carbon_thickness_120808_08am(module_id)
% segmentation_fly_larva_carbon_thickness_120808_08am(module_id)
% 2D segmentation of stack carbon_thickness_tests_120808_0.8nm for
% evaluating the effects of carbon thickness.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'carbon_thickness_tests_120808_0.8nm';   
% (b) image name:
...
config.superpixel_2_seg(1).superpixel_suffix = '.gs_l_T0.3_L75.v_heq'; % 2900x
% (c) thresholds on the boundary field
config.superpixel_2_seg(1).f_threshold_seq = 0.3:0.01:0.82;
...
% For 1900x
config.superpixel_2_seg(2).superpixel_suffix = '.gs_amb_sp_T0.8_0.79_b25.gs_l_T0.3_L75.v_heq.v_heq';
% (c) thresholds on the boundary field
