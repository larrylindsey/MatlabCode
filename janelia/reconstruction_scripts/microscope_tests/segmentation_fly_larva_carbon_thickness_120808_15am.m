function segmentation_fly_larva_carbon_thickness_120808_15am(module_id)
% segmentation_fly_larva_carbon_thickness_120808_08nm(module_id)
% 2D segmentation of stack carbon_thickness_tests_120808_1.5nm for
...
% ".tif".
config.stack.image_prefix = '1stInstar.%gsec.4.0sec.2900x';  
...
config.superpixel_2_seg(1).superpixel_suffix = '.gs_l_T0.3_L75.v_heq'; % 4800x
...
% For 1900x
config.superpixel_2_seg(2).superpixel_suffix = '.gs_amb_sp_T0.68_0.67_b25.gs_l_T0.3_L75.v_heq.v_heq_mf2';
% (c) thresholds on the boundary field
