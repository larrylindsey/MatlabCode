function segmentation_leginon_test_fly_larva_T20_5000x_bin2(module_id)
% segmentation_leginon_test_fly_larva_T20_5000x_bin2(module_id)
% 2D segmentation of stack leginon_test_fly_larva_T20_5000x_bin2 to
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'leginon_tests_fly_larva_T20_5000x_bin2';
% (b) image name:
...
% ".tif".
config.stack.image_prefix = '09jan11b_27982M2_4x4_00006gr_%05dex';  
...
config.superpixel_2_seg(2).superpixel_suffix = ...
  '.gs_amb_sp_T0.76_0.75_b25.gs_l_T0.38_L40.v_heq_mf2.v_heq_mf2';
% (c) thresholds on the boundary field
