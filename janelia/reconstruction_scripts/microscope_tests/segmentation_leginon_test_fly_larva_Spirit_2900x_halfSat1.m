function segmentation_leginon_test_fly_larva_Spirit_2900x_halfSat1(module_id)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'leginon_tests_fly_larva_Spirit_2900x_halfSat1';
% (b) image name:
...
% ".tif".
config.stack.image_prefix = '09jan14a_27985O1.HalfSat_00013gr_%05dex';  
config.stack.image_suffix = '.tif';
% (c) slice ids: If the images are a001.tif, ..., a010.tif then the
% case_ids are 1,2,...,10.
config.stack.case_ids = 588;
...
config.superpixel_2_seg(2).superpixel_suffix = ...
  '.gs_amb_sp_T0.74_0.73_b25.gs_l_T0.44_L150.v_heq_mf2.v_heq_mf3';
% (c) thresholds on the boundary field
