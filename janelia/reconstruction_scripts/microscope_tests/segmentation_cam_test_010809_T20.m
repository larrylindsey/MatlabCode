...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'cam_test_010809_T20';   
% (b) image name:
...
% ".tif".
config.stack.image_prefix = '27932M2.bin%d.NoC.5000x';  
...
% config.superpixel.area_thresholds = 75; % 5000x.bin2, 3500x.bin1
config.superpixel.area_thresholds = 150; % 5000x.bin1
...
%   '.gs_l_T0.44_L75.v_heq_mf2'; % 5000xbin2
config.superpixel_2_seg(1).superpixel_suffix = ...
  '.gs_l_T0.48_L150.v_heq_mf2'; % 5000xbin1
% config.superpixel_2_seg(1).superpixel_suffix = ...
%   '.gs_l_T0.48_L75.v_heq_mf2'; % 3500xbin1
% (c) thresholds on the boundary field
config.superpixel_2_seg(1).f_threshold_seq = 0.48:0.01:0.9;
...
%   '.gs_amb_sp_T0.76_0.75_b25.gs_l_T0.44_L75.v_heq_mf2.v_heq_mf2'; % 5000xbin2
% config.superpixel_2_seg(2).superpixel_suffix = ...
%   '.gs_amb_sp_T0.78_0.77_b25.gs_l_T0.48_L75.v_heq_mf2.v_heq_mf2'; % 3500xbin1
config.superpixel_2_seg(2).superpixel_suffix = ...
  '.gs_amb_sp_T0.78_0.77_b25.gs_l_T0.48_L150.v_heq_mf2.v_heq_mf2'; % 5000xbin1
% (c) thresholds on the boundary field
