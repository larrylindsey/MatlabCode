function segmentation_fly_larva_gatan_scintillator_spirit_P_100208(module_id)
% segmentation_fly_larva_gatan_scintillator_spirit_U_100108(module_id)
% 2D segmentation of stack
% Gatan_P_scintillator_Spirit_U_scintillator_093008 for evaluating the
% microscope.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'Gatan_P_scintillator_Spirit_P_scintillator_100208';   
% (b) image name:
...
config.superpixel_2_seg(1).superpixel_suffix = '.gs_l_T0.3_L50.v_heq_e1'; % 1900x
