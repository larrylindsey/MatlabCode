function segmentation_fly_larva_gatan_scintillator_spirit_U_100108(module_id)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'Gatan_P_scintillator_Spirit_U_scintillator_093008';   
% (b) image name:
...
config.superpixel.f_thresholds = 0.35;
...
config.superpixel_2_seg(1).superpixel_suffix = '.gs_l_T0.35_L500.v_heq'; 
% (c) thresholds on the boundary field
config.superpixel_2_seg(1).f_threshold_seq = 0.32:0.01:0.9;
% (c) thresholds on the boundary field for which segmentations should be
% saved. Useful for reducing disk space.
config.superpixel_2_seg(1).save_f_thresholds = [0.6, 0.7:0.02:0.9];
...
config.superpixel_2_seg(2).superpixel_suffix = '.gs_amb_sp_T0.74_0.73_b25.gs_l_T0.35_L500.v_heq_mf5.v_heq_mf5';
% (c) thresholds on the boundary field
