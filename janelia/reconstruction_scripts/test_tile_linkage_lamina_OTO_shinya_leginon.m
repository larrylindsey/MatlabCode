function test_tile_linkage_lamina_OTO_shinya_leginon(module_id)
% test_tile_linkage_lamina_OTO_shinya_leginon(module_id)
% Test linkage between pairs of tiles on lamina.OTO.shinya.3500x.July2008 J 
%
% module_id
...
config.align_tile.segment_suffix = ...
  '.gs_amb_sp_T0.68_0.67_b25.gs_l_T0.25_L100.v_heq_mf2.v_heq_mf2';
...
config.superpixel_2_seg(1).superpixel_suffix = '.gs_l_T0.25_L100.v_heq_mf2'; 
...
config.superpixel_2_seg(1).save_f_thresholds = 0.68;
