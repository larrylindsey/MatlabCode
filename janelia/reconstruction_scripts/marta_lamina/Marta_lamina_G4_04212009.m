function Marta_lamina_G4_04212009(module_id, case_ids)
...
config.align.global_align.display.save_as_stack_file_name = ...
  [ '~/temp/lamina_align_test_G4_', num2str(config.stack.case_ids(1)), ...
