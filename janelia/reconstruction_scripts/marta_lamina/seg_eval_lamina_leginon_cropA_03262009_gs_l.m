function seg_eval_lamina_leginon_cropA_03262009_gs_l(module_id)
% seg_eval_lamina_leginon_cropA_03262009_gs_l(module_id)
...
config.superpixel.f_thresholds = 0.2:0.01:0.4;
...
config.eval_segment_boundary.seg_suffix_format = ...
  [ '.gs_l_T%g_L150', ...
    '.v_heq2_mf2', ...
    '.v_heq2_mf2'];
config.eval_segment_boundary.seg_suffix_id = config.superpixel.save_f_thresholds;
