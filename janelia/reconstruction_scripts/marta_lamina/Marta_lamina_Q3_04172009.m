function Marta_lamina_Q3_04172009(module_id, case_ids)
...
config.stack.image_structure = 'Qcartridge_elin_network.xml';
% * slice ids: specify the z-plane numbers.
if(nargin>=2)
  config.stack.case_ids = case_ids;
else
  config.stack.case_ids = 19:28;
end
...
config.align.global_align.display.save_as_stack_file_name = ...
  [ '~/temp/lamina_align_test_Q3_', num2str(config.stack.case_ids(1)), ...
...
config.reconstruction.name = '04172009';
...
config.proofreader.import.proofread_name = 'marta.2009.Q3.linkage2_2';
...
'/groups/chklovskii/chklovskiilab/em_reconstruction/proofread_data/lamina.OTO.shinya.leginon.3500x.July2008/region.Qcartridge_elin_network.19.28.Qcartridge_el939393548167_40/marta.2009.Q3.linkage2_2/';
