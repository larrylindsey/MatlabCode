function Marta_lamina_R1_04182009(module_id, case_ids)
...
config.align.global_align.display.save_as_stack_file_name = ...
  [ '~/temp/lamina_align_test_R1_', num2str(config.stack.case_ids(1)), ...
...
config.proofreader.import.proofread_name = 'marta.2009.R1.linkage2_2';
...
config.proofreader.import.Raveler.proofread_data_dir = ...
  '/groups/chklovskii/chklovskiilab/em_reconstruction/proofread_data/lamina.OTO.shinya.leginon.3500x.July2008/region.Rcartridge_elin_network.0.8.Rcartridge_elin744255586476_40/marta.2009.R1.linkage2_2/';
%%%%%%%%%%%%%%%%%%%%%%%%%%
