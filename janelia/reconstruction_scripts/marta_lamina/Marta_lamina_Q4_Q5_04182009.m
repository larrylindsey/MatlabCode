function Marta_lamina_Q4_Q5_04182009(module_id, case_ids)
...
config.align.global_align.display.save_as_stack_file_name = ...
  [ '~/temp/lamina_align_test_Q4_Q5', num2str(config.stack.case_ids(1)), ...
...
config.reconstruction.name = '04182009';
...
% % Use a GUI to choose between a set of parameters for each image.
 ...
 config.segmenataion_choose.choice.seg_suffix = '#(SEG_CHOICE)';
% % * This is a list of superpixel parameters. Each element is a struct with
% % fields:
% %   .method       the segmentation method, e.g., 'grayscale_ladder'.
% %   .seg_suffix   parameters for segmentation, similar to those used in
...
config.proofreader.import.proofread_name = 'marta.2009.Q4_Q5.linkage2_1';
...
'/groups/chklovskii/chklovskiilab/em_reconstruction/proofread_data/lamina.OTO.shinya.leginon.3500x.July2008/region.Qcartridge_elin_network.29.37.Qcartridge_el586769571731_40/marta.2009.Q4_Q5.linkage2_1/';
