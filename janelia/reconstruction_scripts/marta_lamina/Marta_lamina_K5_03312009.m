function Marta_lamina_K5_03312009(module_id)
...
config.stack.image_structure = 'Kcartridge_elin_network.xml';
% * slice ids: specify the z-plane numbers.
config.stack.case_ids = 31:41;
...
config.align.global_align.display.save_as_stack_file_name = ...
  '~/temp/lamina_align_test_K5_31_41.tif';
...
config.reconstruction.name = '03312009';
