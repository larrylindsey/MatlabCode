function Marta_lamina_L3_02122009(module_id)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'L';%'lamina.OTO.shinya.leginon.3500x.July2008';   
% (b) image name:
...
config.stack.image_structure = 'Lcartridge_elin.xml';
% * slice ids: specify the z-plane numbers.
config.stack.case_ids = 17:25;
...
config.reconstruction.name = '02122009';
