function Marta_lamina_S1_04242009(module_id, case_ids)
...
config.stack.image_structure = 'Scartridge_elin_network.xml';
...
config.align.global_align.display.save_as_stack_file_name = ...
  [ '~/temp/lamina_align_test_S1_', num2str(config.stack.case_ids(1)), ...
...
config.reconstruction.name = '04242009';
...
config.proofreader.import.proofread_name = 'marta.2009.S1.linkage2_1';
...
config.proofreader.import.Raveler.proofread_data_dir = ...
  '/groups/chklovskii/chklovskiilab/em_reconstruction/proofread_data/lamina.OTO.shinya.leginon.3500x.July2008/region.Scartridge_elin_network.0.8.Scartridge_elin744255586476_40/marta.2009.S1.linkage2_1/';
