function Marta_lamina_N1_04132009(module_id, case_ids)
...
config.align.global_align.display.save_as_stack_file_name = ...
  [ '~/temp/lamina_align_test_N1_', num2str(config.stack.case_ids(1)), ...
...
config.reconstruction.name = '04132009';
