function Marta_lamina_P2_04162009(module_id, case_ids)
...
config.stack.image_structure = 'Pcartridge_elin_network.xml';
% * slice ids: specify the z-plane numbers.
if(nargin>=2)
  config.stack.case_ids = case_ids;
else
  config.stack.case_ids = 9:18;
end
...
config.align.global_align.display.save_as_stack_file_name = ...
  [ '~/temp/lamina_align_test_P2_', num2str(config.stack.case_ids(1)), ...
