function Marta_lamina_F5_05012009(module_id, case_ids)
...
config.stack.image_structure = 'Fcartridge_elin_network.xml';
% * slice ids: specify the z-plane numbers.
if(nargin>=2)
  config.stack.case_ids = case_ids;
else
  config.stack.case_ids = 54:67;
end
...
config.align.global_align.display.save_as_stack_file_name = ...
  [ '~/temp/lamina_align_test_F5_', num2str(config.stack.case_ids(1)), ...
