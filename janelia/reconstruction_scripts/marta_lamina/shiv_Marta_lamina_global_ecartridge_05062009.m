function shiv_Marta_lamina_global_ecartridge_05062009(module_id, case_ids)
...
config.stack.image_structure = 'global_ecartridge.xml';
...
config.align.global_align.deformable_mesh.optimization.levenberg_marquadt_rigid.gamma = 1;
...
config.reconstruction.name = '05012009';
...
config.linkage.apply.model_suffix = '.v0';%'.01192009';
% (j) Verbose
