function Marta_lamina_H3_04202009(module_id, case_ids)
...
config.stack.image_structure = 'Hcartridge_elin_network.xml';
% * slice ids: specify the z-plane numbers.
if(nargin>=2)
  config.stack.case_ids = case_ids;
else
  config.stack.case_ids = 20:25;
end
...
config.align.global_align.display.save_as_stack_file_name = ...
  [ '~/temp/lamina_align_test_H3_', num2str(config.stack.case_ids(1)), ...
...
config.reconstruction.name = '04202009';
