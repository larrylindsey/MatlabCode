function Marta_lamina_K3_K4_03272009(module_id, case_ids, job_name)
...
config = get_basic_config();
  ...
  config.reconstruction.root_dir ='/groups/visitors/home/albam/em_reconstructions/reconstructions/';
config.to_be_proofread.root_dir = '/groups/visitors/home/albam/em_reconstructions/data_to_be_proofread/';
config.proofreading_session.root_dir = '/groups/visitors/home/albam/em_reconstructions/proofreading_sessions/';
  
global config_global

% Whether in debug mode
config_global.DEBUG = true;
% Whether to generate stand along batch scripts that may be run outside
% MATLAB.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'K';%'lamina.OTO.shinya.leginon.3500x.July2008';   
% (b) image name:
...
config.stack.image_structure = 'Kcartridge_elin.xml';
% * slice ids: specify the z-plane numbers.
if(nargin==1)
  config.stack.case_ids = 19:30;
else
...
config.align.global_align.display.save_as_stack_file_name = ...
  ['~/temp/lamina_align_test_K3K4_', num2str(config.stack.case_ids(1)), ...
  '_', num2str(config.stack.case_ids(end)), '.tif'];
...
config.reconstruction.name = '02112009';
...
%config.superpixel_choose.choice.seg_suffix = '.gs_l_T0.25_L150.v_heq2_mf2_f';
...
config.linkage.train.manual_annotation_file = ...
  '/groups/visitors/home/albam/Desktop/em_reconstrction_spain/manual_annotations/marta.06032008.wcat.no_glia.mat';
