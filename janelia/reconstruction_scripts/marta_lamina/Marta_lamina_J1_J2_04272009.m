function Marta_lamina_J1_J2_04272009(module_id, case_ids)
...
config.align.global_align.display.save_as_stack_file_name = ...
  [ '~/temp/lamina_align_test_J1_J2_', num2str(config.stack.case_ids(1)), ...
...
config.reconstruction.name = '04272009';
