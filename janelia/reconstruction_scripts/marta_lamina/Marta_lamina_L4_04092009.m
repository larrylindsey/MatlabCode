function Marta_lamina_L4_04092009(module_id, case_ids)
...
config.align.precompute.norm_cross_corr_in_plane.is_verbose = false;
...
% Print messages on prompt?
config.align.precompute.norm_cross_corr_inter_plane.is_verbose = false;
% Display results using figures?
...
% Configurations for SIFT. Enable/disable SIFT precomputations
% Print messages on prompt?
config.align.precompute.SIFT.feature_point.is_verbose = false;
...
% Print messages on prompt?
config.align.precompute.SIFT.in_section_match.is_verbose = false;
...
% Print messages on prompt?
config.align.precompute.SIFT.inter_section_match.is_verbose = false;
% Calculate adjacency matrix from trakEM2 tiling
...
% Print messages on prompt?
config.align.precompute.deformable_mesh_in_plane_overlap.is_verbose = false;
% Display results using figures?
...
% Print messages on prompt?
config.align.precompute.deformable_mesh_in_plane_overlap_with_fold.is_verbose = false;
% Display results using figures?
...
config.align.in_section_align.deformable_mesh.is_verbose = false;
% Display results using figures?
...
% Whether to print intermediate messages
config.align.global_align.deformable_mesh.is_verbose = false;
% Display results using figures?
...
config.align.global_align.display.save_as_stack_file_name = ...
  [ '~/temp/lamina_align_test_L2_', num2str(config.stack.case_ids(1)), ...
...
config.trakEM.output_patch_masks_transforms.is_verbose = false;
