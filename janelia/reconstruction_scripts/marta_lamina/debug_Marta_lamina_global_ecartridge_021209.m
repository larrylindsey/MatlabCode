function Marta_lamina_global_ecartridge_021209(module_id, case_ids)
...
config.segmentation_choose.set_choice.method = 'grayscale_AglBIFL';
...
% proofread name (same as used for config.proofreader.import.proofread_name
config.linkage.include_proofread.proofread_name = 'proofcomplete';
