function Marta_lamina_R4_04192009(module_id, case_ids)
...
config.stack.image_structure = 'Rcartridge_elin_network.xml';
% * slice ids: specify the z-plane numbers.
if(nargin>=2)
  config.stack.case_ids = case_ids;
else
  config.stack.case_ids = 30:39;
end
...
config.align.global_align.display.save_as_stack_file_name = ...
  [ '~/temp/lamina_align_test_R4_', num2str(config.stack.case_ids(1)), ...
...
config.reconstruction.name = '04192009';
...
config.proofreader.import.proofread_name = 'marta.2009.R4.linkage2_2';
...
config.proofreader.import.Raveler.proofread_data_dir = ...
  '/groups/chklovskii/chklovskiilab/em_reconstruction/proofread_data/lamina.OTO.shinya.leginon.3500x.July2008/region.Rcartridge_elin_network.30.39.Rcartridge_el822522809497_40/marta.2009.R4.linkage2_2/';
