function Marta_lamina_Q1_04172009(module_id, case_ids)
...
config.align.global_align.display.save_as_stack_file_name = ...
  [ '~/temp/lamina_align_test_Q1_', num2str(config.stack.case_ids(1)), ...
...
config.proofreader.import.proofread_name = 'marta.2009.Q1.linkage2_2';
...
'/groups/chklovskii/chklovskiilab/em_reconstruction/proofread_data/lamina.OTO.shinya.leginon.3500x.July2008/region.Qcartridge_elin_network.0.9.Qcartridge_elin443554825485_40/marta.2009.Q1.linkage2_2/';
