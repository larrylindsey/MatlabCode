function shiv_Marta_Lin_J_20081209(module_id, case_ids)
...
config.align.global_align.display.save_as_stack_file_name = ...
  '~/temp/lamina_align_test_J1_0_9.tif';
...
config.reconstruction.name = '02032009';
...
% detection).
config.superpixel.filter_version = 'v_heq2_mf2_e1';
...
config.superpixel_choose.choice.seg_suffix = '.gs_l_T0.25_L150.v_heq2_mf2_e1_f';
...
% detection).
config.superpixel_2_seg(1).filter_version = 'v_heq2_mf2_e1';
% () whether to display intermediate results
...
% () Image filtering before performing segmentation (affects boundary
% detection)
config.superpixel_2_seg(2).filter_version = 'v_heq2_mf2_e1';
% () whether to display intermediate results
...
config.proofreader.import.proofread_name = ...
  'proofread_session.J.0.9.marta.02062009.mat';
