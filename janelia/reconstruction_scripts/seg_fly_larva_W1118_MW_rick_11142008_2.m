function seg_fly_larva_W1118_MW_rick_11142008_2(module_id)
% seg_fly_larva_W1118_MW_rick_11142008_1(module_id)
% 2D segmentation of images from fly_larva.W1118_MW.rick.11142008
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% (a) stack name
config.stack.name = 'fly_larva.W1118_MW.rick.11142008';   
% (b) image name:
...
% ".tif".
config.stack.image_prefix = '27980S1.Section1.4800X.%d';  
...
% % use superpixel segmentation parameters from previous step
% For grayscale-ladder .gs_l_T<f_threshold>_L<area_threshold>.<filter_version>_<mitochondria m<threshold_d<amount of erosion>>
config.superpixel_2_seg(2).superpixel_suffix = '.gs_amb_sp_T0.77_0.76_b25.gs_l_T0.4_L400.v_heq.v_heq';
% '.gs_l_T0.47_L100.v_heq_mf3_e2_m0_d2_a500'; 
% (c) thresholds on the boundary field
config.superpixel_2_seg(2).f_threshold_seq = 0.70:0.01:0.80; 
% 0.48:0.01:0.9;
% (c) thresholds on the boundary field for which segmentations should be
% saved. Useful for reducing disk space.
config.superpixel_2_seg(2).save_f_thresholds = 0.70:0.01:0.80;
% () minimum boundary length (pixel units) for two segments to be merged
% should increase with increasing f_thresholds. E.g., 0 for f_thresholds
% <=0.65 and 20 otherwise
...
% For 1900x
config.superpixel_2_seg(3).superpixel_suffix = '.gs_amdb_sp_T0.8_0.79_b25.gs_amb_sp_T0.77_0.76_b25.gs_l_T0.4_L400.v_heq.v_heq.v_heq';
% (c) thresholds on the boundary field
