...
for t = 1:num_iter
        ...
        elseif option == 3
            ...
            th = sqrt(5) * kappa;
            cN = (abs(nablaN) < th ) ...
                .* (25 / k16 * (1 - (nablaN / kr5).^2).^2);
            cS = (abs(nablaS) < th ) ...
                .* (25 / k16 * (1 - (nablaS / kr5).^2).^2);
            cW = (abs(nablaW) < th ) ...
                .* (25 / k16 * (1 - (nablaW / kr5).^2).^2);
            cE = (abs(nablaE) < th ) ...
                .* (25 / k16 * (1 - (nablaE / kr5).^2).^2);
            cNE = (abs(nablaNE) < th ) ...
                .* (25 / k16 * (1 - (nablaNE / kr5).^2).^2);
            cSE = (abs(nablaSE) < th ) ...
                .* (25 / k16 * (1 - (nablaSE / kr5).^2).^2);
            cSW = (abs(nablaSW) < th ) ...
                .* (25 / k16 * (1 - (nablaSW / kr5).^2).^2);
            cNW = (abs(nablaNW) < th ) ...
                .* (25 / k16 * (1 - (nablaNW / kr5).^2).^2);
        end
